var mindDesigner = function (g, e, f, h) {
    this.container = $(g);
    this.containerId = g;
    this.opts = $.extend({canvasW: 20000, canvasH: 20000, readonly: false}, e);
    if (h != null) {
...
mindDesigner.prototype = {
    currentRoot: null, render: function () {
        ...
        var g = this, b = g.summary, a = g.model;
        f(e, d, c);
        ...
        var g = this, c = g.model, f = g.summary, q = c.groupList, o = c.topic, e = (o.structure == "mind_org"),
            l = (o.structure == "mind_tree"), a = g.util, h = g.line;
        if (q.freeList.length) {
            for (var r = 0, s = q.freeList.length; r < s; r++) {
                ...
                var n;
                if (e) {
                    n = {x: d.outerWidth() / 2, y: j.outerHeight(), h: j.outerHeight()}
                } else {
                    if (l) {
                        n = {x: 9, y: j.outerHeight(), h: j.outerHeight()}
                    } else {
                        if (m == "left") {
                            n = {x: d.outerWidth() - j.outerWidth(), y: d.outerHeight() / 2 - 0.5, h: j.outerHeight()}
                        } else {
                            n = {x: j.outerWidth(), y: d.outerHeight() / 2 - 0.5, h: j.outerHeight()}
                        }
                    }
                }
        ...
        var g = this, b = g.util, d = g.designer, c = this.model, y = g.operation, x = g.currentRoot || c.topic,
            t = x.structure || c.topic.structure, i = this.styles;
        var p = $("#" + w.id);
        if (p.length > 0) {
            p.parent().remove()
        }
        var e = t == "mind_org", s = t == "mind_tree";
        var z = w.title.replace(/\n/g, "<br>").replace(/\&lt;br\&gt;/g, "<br>"), n = "", u = i.childMarginH;
        if (e) {
            n = "org";
            u = 40
        } else {
        ...
        if (!w.root && w.parent != x.id) {
            ...
            var q = $("#" + w.parent).parent(), j = q.children("." + h), a = q.children(".topic-children-summary");
            if (j.length == 0) {
                j = $("<div class='" + h + "'></div>");
                if (v == "left") {
                    if (a.length > 0) {
            ...
            if (w.pos) {
                ...
                p.css({left: w.pos.x, top: w.pos.y});
                l.addClass("free")
            } else {
        ...
        var d = this.opts, a = b.getTopicDomById(c.id);
        a.css({left: (d.canvasW - a.width()) / 2, top: (d.canvasH - a.height()) / 2})
        ...
        if (c["border-style"] != null && c["border-width"] == null) {
            c["border-width"] = "0px"
        }
        b.removeAttr("style");
        b.css(c);
        ...
        var f = this.model, j = this.currentRoot || f.topic, c = f.topic.background || this.styles.background;
        if (a == "left") {
            i.addClass("left")
        }
        var k = {};
        if (j.structure == "mind_org" || j.structure == "mind_tree") {
            k = {backgroundColor: c, top: d.outerHeight() + 2}
        } else {
            k = {top: (d.outerHeight() - i.outerHeight() * 0.9) / 2 - 1, backgroundColor: c}
        }
        if (g != null) {
            var b = g.lineStyle;
            if (b && b.lineColor) {
        ...
        if (a == "mind_org") {
            c.css({top: b.outerHeight() + 2})
        } else {
            if (a == "mind_tree") {
            } else {
                c.css({top: (b.outerHeight() - c.outerHeight()) / 2 - 0.5})
            }
        }
    }, range: {
        rangeTopics: function (z) {
            var k = this, t = k.opts, m = k.operation, f = k.model, a = k.util, p = k.line,
                G = z.structure || f.topic.structure, B = f.groupList, l = k.styles;
            var d = a.getTopicDomProp(z.id, m.zoomVal / 100);
            B.doGroup(z, G);
            if (G == "mind" || G == "mind_right" || G == "mind_free") {
                var b = z.leftChildren || [], r = B.rightList;
                var q = b.length, s = r.length, F = 0, j = 0, D = l.marginH, u = l.marginW;
                var C = {};
                if (q > 0) {
                    for (var A = 0; A < q; A++) {
                        var c = b[A];
                ...
                var o = d.x + d.w + u, n = d.y + (d.h - j) / 2;
                var h = {x: d.x + d.w / 2, y: d.y + d.h / 2};
                for (var A = 0; A < s; A++) {
                    var c = r[A];
                    var g = H[c.id];
                    g.css({top: n, left: o});
                    var e = {x: o, y: n + g.outerHeight() / 2};
                    ...
                    if (c.children.length > 0 || (c.summaries != null && c.summaries.length > 0)) {
                        ...
                        var w = {x: v.outerWidth(), y: Math.round(g.outerHeight() / 2), h: v.outerHeight()};
                        p.renderLines.call(k, c, w, "right")
                    }
                    n += D + g.outerHeight()
                }
                if (q > 0) {
                    o = d.x - u, n = d.y + (d.h - F) / 2;
                    for (var A = 0; A < q; A++) {
                        var c = b[A];
                        var g = C[c.id];
                        g.css({top: n, right: t.canvasW - o});
                        var e = {x: o, y: n + g.outerHeight() / 2};
                        p.renderSubLine.call(k, c, z, h, e, "left");
                        if (c.children.length > 0 || (c.summaries != null && c.summaries.length > 0)) {
                            var v = g.children(".topic-box");
                            var w = {x: v.position().left, y: Math.floor(g.outerHeight() / 2), h: v.outerHeight()};
                ...
                if (G == "mind_org") {
                    var r = B.rightList;
                    var s = r.length, E = 0, D = l.marginH, u = l.marginW;
                    var H = {};
                    for (var A = 0; A < s; A++) {
                        var c = r[A];
                        k.renderSubTopic(c, "right");
                    ...
                    var h = {x: d.x + d.w / 2, y: d.y + d.h};
                    var o = h.x, n = d.y + d.h + D * 2;
                    for (var A = 0; A < s; A++) {
                        var c = r[A];
                        var g = H[c.id];
                        g.css({top: n, left: o});
                    ...
                    for (var A = 0; A < s; A++) {
                        ...
                        var g = H[c.id];
                        g.css({left: o});
                        var e = {x: o + g.outerWidth() / 2, y: n};
                        p.renderSubLine.call(k, c, z, h, e, "right");
                        if (c.children.length > 0 || (c.summaries != null && c.summaries.length > 0)) {
                            var v = g.children(".topic-box");
                            var w = {x: g.outerWidth() / 2, y: v.outerHeight(), h: v.outerHeight()};
                            p.renderLines.call(k, c, w, "right")
                        }
                        o += g.outerWidth() + u / 2
                    }
                    ...
                    if (G == "mind_tree") {
                        ...
                        for (var A = 0; A < s; A++) {
                            ...
                            var g = H[c.id];
                            g.css({left: o});
                            var e = {x: o + g.children(".topic-box").outerWidth() / 2, y: n};
                            p.renderSubLine.call(k, c, z, h, e, "right");
                            if (c.children.length > 0) {
                                var v = g.children(".topic-box");
                                var w = {x: 10, y: v.outerHeight(), h: v.outerHeight()};
                                p.renderLines.call(k, c, w, "right")
                            }
                            o += g.outerWidth() + u / 2
                        }
            ...
            var e = j.model, p = j.currentRoot || e.topic, t = e.groupList, u = t.rightList.length, b = j.util,
                a = j.operation.zoomVal / 100;
            var d = b.getTopicDomProp(p.id, a);
            var m = t.rightList, w = 0, z = {};
            var g = {x: d.x + d.w / 2, y: d.y + d.h};
            var l = g.x, k = d.y + d.h + v * 2;
            for (var s = 0; s < u; s++) {
                var c = m[s];
            ...
            var d = i.model, m = i.opts, t = i.currentRoot || d.topic, g = (t.structure == "mind_org"),
                p = (t.structure == "mind_tree"), b = i.util, e, z = 0, j = i.styles, k = i.operation,
                a = k.zoomVal / 100, A = j.marginH, n = j.marginW;
            if (g || p) {
            ...
            if (s == "right") {
                var w = d.groupList, x = w.rightList.length;
                var c;
                if (x == 1) {
                    c = b.getTopicDomProp(t.id, a);
                    e.css({left: c.x + c.w + n, top: c.y + (c.h - e.outerHeight()) / 2});
                    return
                } else {
                    ...
                    e.css({left: c.x, top: l})
                }
                i.range.doChangeSubTopicPos(i, r, z, 0, s)
            } else {
                if (s == "left") {
                    var f = t.leftChildren, x = f.length;
                    var c;
                    if (x == 1) {
                        c = b.getTopicDomProp(t.id, a);
                        e.css({right: m.canvasW - c.x + n, top: c.y + (c.h - e.outerHeight()) / 2});
                        return
                    } else {
                        ...
                        e.css({right: m.canvasW - c.x - c.w, top: l})
                    }
                    i.range.doChangeSubTopicPos(i, r, z, 0, s)
                }
            }
            ...
            var g = m.model, o = m.currentRoot || g.topic, k = m.util, n = g.groupList.rightList;
            var e = true;
            var l = n.length;
            for (var f = 0; f < l; f++) {
                var p = n[f];
            ...
            var a = e.util, c = e.model, n = e.currentRoot || c.topic;
            if (n.structure == "mind_org" || n.structure == "mind_tree") {
                this.doChangeOrgSubTopicPos(e, f, q, g, m, j);
                return
            }
            if (f.root) {
                var d = a.getTopicContainer(f.id), l = f.leftChildren || [];
                if (q > 0) {
            ...
            var c = e.model, n = e.currentRoot || c.topic, a = e.util, s = c.groupList.rightList;
            var u = true;
            if (m == "left") {
                s = n.leftChildren
            }
            ...
            var j = this, f = j.model, t = this.currentRoot || f.topic, m = j.operation, a = m.zoomVal / 100,
                q = j.opts, b = j.util, p = j.line, D = t.structure, v = f.groupList, l = j.styles;
            ...
            var w = z.length, B = 0, A = l.marginH, r = l.marginW;
            var k = {};
            if (w > 0) {
                for (var u = 0; u < w; u++) {
                    var c = z[u];
            ...
            var h = {x: d.x + d.w / 2, y: d.y + d.h / 2}, n = d.y + (d.h - B) / 2;
            if (s == "left") {
                var o = d.x - r;
                for (var u = 0; u < w; u++) {
                    var c = z[u];
                    var g = k[c.id];
                    g.css({top: n, right: q.canvasW - o});
                    var e = {x: o, y: n + g.outerHeight() / 2};
        ...
        var b = this.container, c = this.model.topic, f = this.opts, e = this.styles, a = $(window).height();
        b.css({height: f.height ? f.height : a - b.siblings("div:visible:not(.embeditem)").height()});
        var d = $("<div class='mind-designer'></div>").appendTo(b);
        d.css({width: f.canvasW, height: f.canvasH});
        this.designer = d;
        this.operation.moveToCenter.call(this);
        this.operation.setBackground.call(this);
        this.initEvent()
    }, initEvent: function () {
        var k = this, a = k.opts, e = k.operation, h = k.util, g = k.model, m = g.topic, c = k.connection;
        $(document).off("mousedown.dragmove").on("mousedown.dragmove", function (r) {
            var q = r.pageX, s = r.pageY;
        ...
        $(document).off("mouseup.expand").on("mouseup.expand", ".expand_box", function (q) {
            var p = $(this), o = p.parent(), r = o.attr("id");
        ...
        $(window).on("resize.canvas", function (r) {
            var o = $(window).height(), q = $(window).width();
            var p = k.container;
            p.css({height: k.opts.height ? k.opts.height : o - p.siblings("div:visible").height()})
        });
        var j = "", l = 0;
                                                    ...
                                                    if (o == 88 && (v.ctrlKey || v.metaKey)) {
                                                        ...
                                                        if (o == 86 && (v.ctrlKey || v.metaKey)) {
                                                            ...
                                                            if (s != "") {
                                                                ...
                                                                $.showTip("璇烽€夋嫨涓婚鍚庯紝鍐嶈繘琛岀矘璐�", 1200)
                                                            }
                                                            v.preventDefault()
                                                        } else {
                                                                            ...
                                                                            if (o == 17 || o == 91) {
                                                                                ...
                                                                                if (o == 66 && (v.ctrlKey || v.metaKey)) {
                                                                                    ...
                                                                                    if (s != "") {
                                                                                        var w = g.getTopicById(s);
                                                                                        if (w.style == null) {
                                                                                            mind.operation.setStyle.call(mind, {"font-weight": "bold"})
                                                                                        } else {
                                                                                            if (w.style.bold != null && w.style.bold == false) {
                                                                                                ...
                                                                                                if (w.style["font-weight"] == "normal" || w.style["font-weight"] == null) {
                                                                                                    ...
                                                                                                    mind.operation.setStyle.call(mind, {"font-weight": "normal"})
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                                    ...
                                                                                                    if (o == 75 && (v.ctrlKey || v.metaKey)) {
                                                                                                        ...
                                                                                                        if (o == 73 && (v.ctrlKey || v.metaKey)) {
                                                                                                            ...
                                                                                                            if (s != "") {
                                                                                                                var w = g.getTopicById(s);
                                                                                                                if (w.style == null) {
                                                                                                                    mind.operation.setStyle.call(mind, {"font-style": "italic"})
                                                                                                                } else {
                                                                                                                    if (w.style.bold != null && w.style.bold == false) {
                                                                                                                        mind.operation.setStyle.call(mind, {"font-style": "italic"})
                                                                                                                    } else {
                                                                                                                        if (w.style["font-style"] == "normal" || w.style["font-style"] == null) {
                                                                                                                            ...
                                                                                                                            mind.operation.setStyle.call(mind, {"font-style": "normal"})
                                                                                                                        }
                                                                                                                    }
                                                                                                                }
                                                                                                            }
        ...
        k.designer.off("mousedown.dragmovefree").on("mousedown.dragmovefree", ".topic-box.free", function (J) {
            ...
            var C = $(this), G = C.attr("id"), E = Math.abs, q = k.operation.zoomVal / 100;
            ...
            var D = h.getTopicContainer(G), H = D.outerHeight();
            var A = J.pageX, w = J.pageY, z = D.offset().left, v = D.offset().top;
            var r = A - z, o = w - v, B = false, O = {};
            var L = D.position().left, K = D.position().top;
            ...
            k.designer.off("mouseup.dragmovefree").on("mouseup.dragmovefree", function (R) {
                ...
                if (B) {
                    ...
                    if (O.id != null) {
                        ...
                        if (B) {
                            var P = D.position().left / q, T = D.position().top / q;
                            var S = {x: P, y: T};
        ...
        k.designer.off("dblclick.freetopic").on("dblclick.freetopic", ".mind-line-svg", function (q) {
            ...
            if (k.currentRoot != null) {
                $.showTip("鑱氱劍妯″紡涓嬫棤娉曟柊寤鸿嚜鐢变富棰�", 1400);
                return
            }
            var o = {parent: m.id, title: "鑷敱涓婚", children: [], id: g.newId()};
        ...
        k.designer.off("mousedown.dragmovetp").on("mousedown.dragmovetp", ".topic-box:not(.free)", function (t) {
            ...
            if (s.root) {
                ...
                e.topicDrag.call(k, {x: z, y: w}, s, r, t)
            }
        ...
        $(document).on("click", ".connection-line", function (s) {
            var p = m.lines;
            var r = $(this), o = r.attr("id").substring(5);
            var q = p[o];
            c.isFocus = false;
        ...
        k.designer.off("blur.conn-label").on("blur.conn-label", ".mind-connection-label", function (r) {
            var q = $(this), s = $.trim(q.html()), p = c.tempLine || c.currentLine;
            if (p == null) {
                return
            }
            if (p.label != s) {
        ...
        k.designer.off("focus.conn-label").on("focus.conn-label", ".mind-connection-label", function (q) {
            var p = $(this), r = $.trim(p.html()), o = c.currentLine;
            c.tempLine = o
        });
        ...
        k.designer.on("mousedown.imagemove", ".topic-image > img", function (t) {
            var r = $(this), p = t.pageX, u = t.pageY, o = Math.abs, s = false, q = r.parent().parent().attr("id");
            $.showTip("鎷栧姩鍒板叾浠栦富棰樹笂锛屽彲浠ュ揩閫熷鍒跺浘鐗�", null);
            k.designer.off("mousemove.imagemove").on("mousemove.imagemove", function (w) {
                var v = w.pageX, x = w.pageY;
                if (o(p - v) > 5) {
                    if (!s) {
                        s = true
                    }
            ...
            k.designer.off("mouseup.imagemove").on("mouseup.imagemove", function (y) {
                ...
                s = false;
                $.showTip("close");
                var C = $(y.target).parents(), z = false, v = null;
        ...
        k.designer.on("click.image", ".topic-image > img", function (x) {
            ...
            k.designer.find(".topic-image .img-btn").remove();
            k.designer.find(".topic-image img.active").removeClass("active");
            var o = $("<span title='璋冭妭鍥剧墖澶у皬' class='img-dot'></span>");
            u.parent().append(o);
            var s = $("<span title='鍒犻櫎鍥剧墖' class='img-btn del'><span class='mind-icons'>&#xe618;</span></span>");
            u.parent().append(s);
            u.addClass("active");
            o.css({top: z - o.height() + 2, left: t - o.width()}).show();
            $(".topic-image .img-dot").off("mousedown").on("mousedown", function (B) {
                B.stopPropagation();
                var w = B.pageX, D = B.pageY, A = u.width(), C = u.height();
                s.hide();
                k.designer.off("mousemove.img-dot").on("mousemove.img-dot", function (G) {
                    G.preventDefault();
                    G.stopPropagation();
                    var E = G.pageX, I = G.pageY, H = E - w, F = I - D;
                    if (Math.abs(H) > 5 || Math.abs(F) > 5) {
                        ...
                        if (y > 20) {
                            u.width(y);
                            u.height(v);
                            o.css({left: y - o.width(), top: v - o.height()})
                        }
                    }
                });
                k.designer.off("mouseup.img-dot").on("mouseup.img-dot", function (E) {
                    ...
                    var F = h.copy(r);
                    s.show();
                    F.image = $.extend(true, F.image, {w: A, h: C});
        ...
        k.designer.off("click.clickicon").on("click.clickicon", ".topic-icons > span", function (q) {
            var p = $(this), s = p.attr("n"), o = p.attr("ico");
        ...
        moveToCenter: function () {
            var b = this.container, j = $(".mind-designer:first"), f = this, e = f.model, h = f.currentRoot || e.topic,
                a = b.width(), i = b.height();
            var c = 0, g = 0;
            ...
            b.scrollLeft(c);
            b.scrollTop(g)
        }, draging: false, topicDrag: function (d, n, p, r) {
            var f = this, c = f.model, a = f.util, i = f.line, m = f.currentRoot || c.topic, o = c.groupList,
                t = f.styles.marginH;
            var b = p.clone(false).appendTo("body").addClass("topic-moving");
            b.children(".topic").siblings().remove();
            var k = p.offset().left, j = p.offset().top;
            var s = d.x - k, q = d.y - j;
            var u = {};
            var g = c.getParentTopic(n.parent), l = p.parent();
            var h = false;
            $(".mind-util-container").addClass("noevent");
            $("header").addClass("noevent");
            $(".mind-canvas-con").addClass("noevent");
            ...
            f.designer.off("mousemove.dragmove").on("mousemove.dragmove", function (w) {
                var v = w.pageX - d.x, y = w.pageY - d.y;
                var e = Math.abs(v), x = Math.abs(y);
                if (e > 8 || x > 8) {
                    ...
                    if ($(".mind-tip").length == 0) {
                        $.showTip("鎷栧姩鍒板叾浠栦富棰樹笂锛岃繘琛屾帓搴忔垨绉诲姩", null)
                    }
                    if (x > 200 || e > 200) {
                        if (w.target.tagName == "svg") {
                            $.showTip("鏉惧紑榧犳爣锛屽嵆鍙坊鍔犱负鑷敱涓婚", null)
                        }
                    }
                    b.css({left: w.pageX - s, top: w.pageY - q})
                }
            });
            f.designer.off("mouseup.dragmove").on("mouseup.dragmove", function (v) {
                var e = v.pageX - d.x, A = v.pageY - d.y;
                ...
                var y = b.offset().left, x = b.offset().top;
                b.remove();
                $(".topic-insert").remove();
                $(".topic-moving-target").removeClass("topic-moving-target");
                $(this).css({cursor: "default"});
                    ...
                    if (u.id != null) {
                        ...
                        if (h) {
                            if (mind.currentRoot != null) {
                                $.showTip("鑱氱劍妯″紡涓嬫棤娉曟垚鑷敱涓婚", 1400);
                                return
                            }
            ...
            var o = this, k = o.model, s = o.line, q = o.currentRoot || k.topic, m = o.operation, l = o.util;
            ...
            var h = this, f = h.model, l = h.line, j = h.currentRoot || f.topic;
        ...
        }, focusTopic: function (j) {
            var g = this, e = g.model, f = g.util, b = "", h = e.topic;
            g.operation.zoomVal = 100;
            g.events.push("zoom", 100);
            var c = null;
            if (j != null) {
                b = j
            } else {
            ...
            var d = e.getTopicById(b);
            if (d != null) {
                if (g.currentRoot != null) {
                    var i = e.getTopicById(g.currentRoot.id);
                    c = i.id;
                    delete i.root;
                    delete i.structure;
                    g.currentRoot = null
                ...
                if (d.root == null) {
                    g.currentRoot = d;
                    g.currentRoot.root = true;
                    g.currentRoot.structure = h.structure
                }
                g.operation.clearCanvas.call(g);
                g.initCanvas();
                g.line.renderLineCon.call(this);
                g.renderTopic(d);
                g.plugins.navigator.init.call(g);
                g.operation.renderFocusBar(g);
                g.messageSource.send.call(g, "focus", {targetId: b, sourceId: c}, true)
            }
            if (g.currentRoot == null) {
                g.events.push("focus", null)
            } else {
                g.events.push("focus", true)
            }
        }, renderFocusBar: function (c) {
            var g = c.currentRoot;
            if (g != null) {
                var f = c.model.getParentTopics(g.id);
                $(".mind-util-container").find(".mind-topic-focus").remove();
                var b = ['<div class="mind-topic-focus">'];
                for (var a = f.length - 1; a >= 0; a--) {
                    var e = f[a], d = e.title;
                    b.push('<div topicid="' + e.id + '">' + d + '</div><i class="mind-icons">&#xe736;</i>')
                }
                b.push('<div class="active" topicid="' + g.id + '">' + g.title + '</div><i title="閫€鍑鸿仛鐒︽ā寮�" class="mind-icons close">&#xe622;</i>');
                b.push("</div>");
                $(".mind-util-container").append(b.join(""));
                this.initFocusEvent(c)
            } else {
                $(".mind-topic-focus").remove()
            }
        }, initFocusEvent: function (b) {
            var a = $(".mind-topic-focus");
            a.children().off("click").on("click", function (f) {
                var d = $(this);
                if (d.hasClass("active")) {
                    return
                }
                if (this.tagName.toLowerCase() == "div") {
                    var c = d.attr("topicid");
                    if (c != null) {
                        b.operation.focusTopic.call(b, c)
                    }
                    if (c == b.model.topic.id) {
            ...
            var g = this, c = g.model, r = c.topic, d = (r.structure == "mind_org"), l = (r.structure == "mind_tree"),
                b = g.util, h = g.line;
            if (this.util.selectedIds.length == 0) {
                return
            }
            var m = b.getSelectedId(), k = null, a = c.getTopicById(m), i = c.newId(), u = "瀛愪富棰�", p = "right";
            if (t && a.collapsed) {
                return
            }
            ...
            n[i] = p;
            j[i] = e;
            var q = {id: i, parent: s, children: [], title: u};
            c.addTopicMulti.call(g, [q], j, n);
            b.selectOne.call(g, q);
            g.events.push("outline-prebuild", {id: m, insertChild: t});
            return q
        }, hideTopics: function (h) {
            var f = this, b = f.model, a = f.currentRoot || b.topic;
            var d = a.children, g = a.leftChildren || [];
            var e = [];
            ...
            var l = this, j = l.model, g = j.groupList, m = l.currentRoot || j.topic, d = j.getSubTopic(i), k = l.util,
                p = l.line;
            var e = k.getTopicContainerProp(d.id), c = k.getSelectedPart(i.id, m.structure);
            ...
            var j = this, b = j.model, a = j.util, o = j.currentRoot || b.topic, l = j.line, q = b.groupList;
            var e = b.getSubTopic(p), n = a.getSelectedPart(p.id, o.structure);
            var d = p.children, t = d.length;
            ...
            var j = this, g = j.util, f = j.model, m = j.currentRoot || f.topic;
            var b = g.getTopicDom(a), k = b.children(".expand_box");
            var e = f.getTopicById(a), i = "&#xe7bb;", h = "&#xe647;";
        ...
        }, isPaste: false, editTopicDomInit: function (c) {
            var i = this, h = i.operation, g = i.util;
            var f = i.model.getTopicById(c), e = i.util.getTopicDom(c);
            var n = f.title, j = e.find(".topic");
            ...
            var l = n.replace(/\n/g, "<br>");
            b.html(l).focus();
            b.css({left: 0, width: j.outerWidth(), height: j.outerHeight()});
            if (f.image != null) {
                b.css({bottom: 0 - b.height() / 2, top: "auto"})
            }
            if (f.tags != null) {
                b.css({top: b.height() / 2 + 2})
            }
                    ...
                    if (g.isChrome()) {
                        ...
                        if (r) {
                            ...
                            if (v && v.kind === "file" && v.type.match(/^image\//i) && s.length != 4) {
                                var q = v.getAsFile(), w = new FileReader();
                                w.readAsDataURL(q);
                                w.onload = function (A) {
                                    var z = w.result;
                                    h.uploadImage(z, c, function (C) {
                                        if (C.result) {
                                            ...
                                            if (C.result == "type_error") {
                                                $.showTip("鏂囦欢绫诲瀷閿欒锛岃涓婁紶鍥剧墖", 3000);
                                                return
                                            }
                                            $.showTip("鍗囩骇鍒颁釜浜虹増鎴栬€呭洟闃熺増鍚庯紝鎵嶅彲浠ョ洿鎺ョ矘璐存埅鍥撅紝 <a style='color:#fff;letter-spacing:1px;' href='/upgrade' target='_blank'>鍘诲崌绾�</a>", 7000)
                                        } else {
                                            var B = new Image();
                                            B.src = C.img_url;
        ...
        }, uploading: false, uploadImage: function (b, d, c) {
            var a = this;
            if (a.uploading) {
                return
            }
            a.uploading = true;
            $.ajax({
                url: "/mindmap/uploadimage", type: "post", data: {id: chartId, img: b}, success: function (e) {
                    a.uploading = false;
                    if (c != null) {
                        c(e)
                    }
            ...
            var i = this, f = i.model, g = i.util, l = false, d = false, h = i.operation;
            var b = $("#area_" + a);
            if (b.length == 0) {
                this.operation.editTopicDomInit.call(i, a);
                b = $("#area_" + a)
            }
            var e = f.getTopicById(a), c = g.getTopicDom(a);
            var n = e.title, j = c.find(".topic"), o = $("#textarea_topic_temp");
            b.css({"z-index": 9, width: j.parent().outerWidth(), opacity: 1});
            if (e.image != null) {
                b.css({bottom: 0 - b.height() / 2, top: "auto"})
            }
            var k = n.replace(/\n/g, "<br>");
            ...
            b.off().on({
                keydown: function (p) {
                    ...
                    b.css({width: p, height: r, left: (c.outerWidth() - (p)) / 2 - 3});
                    if (e.image != null) {
                        b.css({bottom: 0 - b.height() / 2, top: "auto"})
                    }
                    s.stopPropagation()
            ...
            var m = function (s, r) {
                ...
                if (i.util.isPaste == "safari") {
                    ...
                    if (q.length > 0) {
                        $.showTip("close");
                        $.showTip("Firfox鍜孲afari娴忚鍣ㄦ殏鏃惰繕涓嶆敮鎸佺矘璐存埅鍥�", 4000);
                        q.remove();
                        s = e.title
                    } else {
                ...
                i.events.push("outline-prebuild", {id: a, rebuild: "current"})
            }
        }, setDisable: function () {
            ...
            var d = $(this.designer), f = this.styles, b = this.model.topic, h = b.background || f.background;
            ...
            if (g) {
                b.background = c;
                if (a == null) {
                    this.messageSource.send.call(this, "updateBg", {content: c, original: h})
                }
            }
            this.designer.find(".expand_box").css("background-color", c)
        }, showLink: function () {
            var g = this, e = g.util, c = g.model, a = e.getSelectedId(), f = g.operation;
            if (a == null || $.trim(a) == "") {
                return
            }
            if (g.opts.readonly) {
            ...
            var k = $(".mind-link-box");
            if (k.length == 0) {
                k = $("<div class='mind-topic-box mind-link-box'><h3>瓒呴摼鎺�<span id='remove_link' style='cursor:pointer;font-size:13px;font-size: 13px;font-weight: normal;float: right;text-decoration: underline;'>鍒犻櫎</span></h3><div><span>閾炬帴鍦板潃锛�</span><input id='mind-topic-link' autofocus type='text'/></div><div><span>鏄剧ず鏍囬锛�</span><input  id='mind-topic-linktitle' type='text'/></div><div class='mind-topic-box-btn'><span class='mind-button green'>娣诲姞</span></div></div>").appendTo(g.designer)
            }
            ...
            h.off().on("click", function () {
                ...
                if (o != "" && e.isUrl(o) && o.length < 200) {
                    ...
                    var m = {value: o, title: l, type: "url"};
                    f.setLink.call(g, m);
                    f.hideLink()
                } else {
                    n.val("").focus();
                    n.attr("placeholder", "璇疯緭鍏ュ悎娉曠殑URL鍦板潃")
                }
            });
            ...
            var f = this, e = f.util, d = f.model, a = i || e.getSelectedId();
            ...
            var k = $.trim(j.value), c = d.getTopicById(a), g = c.link;
            if (g == null) {
                c.link = {}
            }
            var b = e.copy(c);
            ...
            c.link = {value: j.value, type: h || "url", title: j.title};
            d.updateTopicNode.call(f, c, b, "link")
        }, removeLink: function () {
            var e = this, b = e.util, d = e.model, f = b.getSelectedId();
            if (f == null || $.trim(f) == "") {
                return
            }
            if (e.opts.readonly) {
            ...
            var f = this, b = f.util, d = f.model, h = b.getSelectedId();
            if (h == null || $.trim(h) == "") {
                return
            }
            if (f.opts.readonly) {
            ...
            var j = this, g = j.util, e = j.model, a = g.getSelectedId();
            if (a == null || $.trim(a) == "") {
                return
            }
            if (j.opts.readonly) {
            ...
            var c = g.copy(f);
            var i = g.copy(f);
            i.image = $.extend(true, {w: d.width, h: d.height}, {url: a});
            e.updateTopicImage.call(h, i, c)
        }, removeTopicImage: function (f) {
            var e = this, d = e.model, b = e.util;
            if (e.opts.readonly) {
                return
            }
            var c = d.getTopicById(f);
            ...
            var g = this, c = g.model, n = c.topic, h = g.operation, r = g.messageSource, l = n.structure;
            h.zoomVal = 100;
            n.structure = m;
            var o = "&#xe6fe;";
            switch (m) {
            ...
            function j(i) {
                ...
                mind = new mindDesigner("#mind_con", {chartId: chartId}, n, u);
                if (s == null) {
                    r.send.call(g, "updateStructure", {content: i, original: l})
                }
            }
        ...
        }, zoomVal: 100, zoomIn: function (a) {
            var b = this, e = b.operation;
            ...
            if (a != null) {
                b.css({"transform-origin": a, "-webkit-transform-origin": a})
            }
            mind.plugins.navigator.init.call(mind)
        }, initBrash: function (e) {
            var a = e.util, h = a.getSelectedId(), b = e.model, g = e.operation;
            if (h == "") {
                return
            }
            ...
            var f = this, d = f.util, c = f.model, e = f.operation, g = f.currentRoot || c.topic;
        ...
        }, brashData: {id: null, style: null}, showTip: function () {
            $("#mind-brash-tip").show().css({left: 25, top: 70})
        }, closeTip: function () {
            $("#mind-brash-tip").hide();
            this.brashData.style = null;
            this.brashData.id = null;
            $(".brash").addClass("mind-disable")
        }, scrollStv: null, scrollIsOver: false, scrollLayout: null, scrollPos: {}, initScrollPos: function () {
            var a = $(window);
...
mindDesigner.prototype.line = {
    renderLineCon: function () {
        ...
        var h = this, u = document, d = h.model, o = h.currentRoot || d.topic, b = h.line, i = h.styles;
        var f = u.getElementsByClassName("svg-topic-con")[0], r = h.style, a = h.util;
        var k = $("#line_" + q.id);
        if (k.length) {
            k.remove()
        }
        ...
        if (o.structure == "mind_org" || o.structure == "mind_tree") {
            ...
            m = a.copy(b.getSubLinePath(c, q, j, i.thinner, g, e, n, o.id))
        }
        ...
        var a = Math.ceil(h.x), f = Math.ceil(c.y);
        var e = "M" + a + " " + h.y + " L" + a + " " + (f - 23) + " L" + c.x + " " + (f - 23) + " L" + c.x + " " + (f);
        if (g) {
            return e
        }
        return {d: e, stroke: b.lineColor, fill: "none", "stroke-width": b.lineWidth}
    }, getSubLinePath: function (f, e, h, j, a, c, b, i) {
        var d = f.lineType, g = "sub" + d + "UnderLine";
        if (f.underLine && this.linePaths[g] != null) {
            return this.linePaths[g](e, h, f, a, c, j, b, null, i)
        }
        return this.linePaths["sub" + d](e, h, f, a, c, j, b, null, i)
        ...
        var i = a.y + 2, l = a.x + c.w + 10;
        var g = "M" + a.x + " " + i + " L" + a.x + " " + c.y + "L" + l + " " + c.y;
        if (h) {
            return g
        }
        return {d: g, p: j.id, stroke: f.lineColor, fill: "none", "stroke-linecap": "round", "stroke-width": 1}
        ...
        var j = this, h = j.util, i = j.operation, m = i.zoomVal / 100, o = j.line, g = j.model,
            k = j.currentRoot || g.topic, f = k.structure;
        if (b == "left") {
            l(d, a)
        } else {
            e(d, a)
        ...
        function e(t, p) {
            ...
            var q = t.children, u = q.length;
            var x = t.summaries, v = q;
        ...
        var f = this, b = f.model, n = f.currentRoot || b.topic, q = f.style, k = n.structure || b.topic.structure;
        var h = $("#line_" + o.id);
        ...
        var b = g.line;
        if (f.root) {
            b.renderSubLine.call(g, e, f, {x: 0, y: 0, h: 0}, {x: 0, y: 0, h: 0}, c)
        } else {
            var a = document.getElementById("subline_" + d);
            b.renderLine.call(g, e, f, {x: 0, y: 0, h: 0, w: 0}, {x: 0, y: 0, h: 0, w: 0}, d, c)
        }
    }, renderNewLines: function (g, d, c) {
        var b = g.line, f = d.children, a = f.length;
        if (a > 0) {
            for (var e = 0; e < a; e++) {
                var h = f[e];
        ...
        var j = this, b = j.util, e = j.model, l = j.operation, a = l.zoomVal / 100, r = j.currentRoot || e.topic,
            k = j.styles, m = j.line, v = $(".svg-topic-con");
        var p = null;
        ...
        for (var s = 0; s < t; s++) {
            ...
            if (r.structure == "mind_org" || r.structure == "mind_tree") {
                ...
                h = m.linePaths["sub" + w.lineType](null, null, null, g, f, k.thinner, o, true, r.id)
            }
            u.setAttribute("d", h)
        }
    }, resetLines: function (J, G, A) {
        var n = this, b = n.util, t = n.opts, p = n.operation, a = p.zoomVal / 100, g = n.model,
            C = n.currentRoot || g.topic, w = C.structure || g.topic.structure, o = n.styles, s = n.line,
            H = $(".svg-topic-con"), z;
        if (A != null && A.indexOf("left") >= 0 && A.indexOf("right") < 0) {
            z = H.children("path[part=left]")
        } else {
            if (A != null && A.indexOf("left") >= 0 && A.indexOf("right") >= 0) {
                z = H.children("path")
            } else {
                z = H.children("path[part=right]")
            }
        }
        var l = (w == "mind_org");
        var v = (w == "mind_tree");
        ...
        var e = {};
        var d = b.getTopicDomProp(C.id, a);
        var k = {x: d.x + d.w / 2, y: d.y + d.h / 2};
        for (var D = 0; D < F; D++) {
            var E = z[D];
            var u = E.getAttribute("id").substr(5);
            var x = E.getAttribute("part");
            var f;
            if (l) {
            ...
            var I = n.style.getLineStyle.call(n, c);
            var m;
            if (l || v) {
                m = s.getOrgSubLinePath(I, k, f, true)
            } else {
                m = s.linePaths["sub" + I.lineType](null, null, null, k, f, o.thinner, x, true, C.id)
            }
            E.setAttribute("d", m)
        }
        if (J.length > 0) {
            for (var D = 0; D < J.length; D++) {
                var u = J[D], r = g.getTopicById(u);
                if (r == null) {
                    continue
                }
                var j = $("#subline_" + u), y = j.children("path"), q = y.length, x = e[u];
                if ((r.children.length == 0 && r.summaries == null) || j.length == 0) {
                    continue
                }
                if (x == null) {
                    x = A
                ...
                s.renderLines.call(n, r, k, x)
            }
        }
    }, deleteLine: function (b) {
        var e = this, d = b.children, a = d.length;
        ...
        subcurve: function (h, n, i, a, g, o, b, m) {
            if (o) {
                ...
                return {d: j, stroke: i.lineColor, fill: i.lineColor, "stroke-width": 2}
            } else {
                var l = ["M"];
                l.push(a.x);
                l.push(a.y);
                ...
                return {d: j, stroke: i.lineColor, fill: "none", "stroke-width": i.lineWidth}
            }
            ...
            if (m) {
                ...
                return {d: h, stroke: g.lineColor, fill: g.lineColor, "stroke-width": 2}
            } else {
                var j = "M" + a.x + " " + a.y + " L" + e.x + " " + e.y;
                if (k) {
                    return j
                }
                return {d: j, stroke: g.lineColor, fill: "none", "stroke-width": g.lineWidth}
            }
            return path
        }, subbroken: function (e, k, f, a, c, l, b, h) {
            if (l) {
            } else {
                var j = Math.ceil(a.x), i = Math.ceil(c.y);
                var g = "M" + j + " " + a.y + " L" + j + " " + i + " L" + c.x + " " + i;
                if (h) {
                    return g
                }
                return {d: g, stroke: f.lineColor, fill: "none", "stroke-width": f.lineWidth}
            }
            return path
            ...
            if (l) {
                ...
                return {d: h, stroke: g.lineColor, fill: "none", "stroke-width": g.lineWidth}
            }
            return path
        }, subcurveUnderLine: function (h, m, i, c, f, n, e, l) {
            var k = ["M"], b = $("#" + h.id), a = b.outerHeight(), g = b.outerWidth();
            f.y = f.y + a / 2 - 1.5;
            if (e == "left") {
                f.x = f.x - 1
            } else {
            ...
            var f = e.x - 20, g = a.x + 24, c = 16;
            if (b == "left") {
                f = e.x + 24 + e.w, g = a.x - 20;
                c = -16;
                o += e.w
            }
            var m = (a.y + e.y) / 2;
...
mindDesigner.prototype.summary = {
    model: {
        styles: {lineColor: "#bf1e1b", lineWidth: "1", lineType: "broken"},
        currentStyle: null,
        addSummary: function (p, d) {
            var m = this, k = m.util, j = m.model, o = m.currentRoot || j.topic, r = m.line, h = j.groupList;
            var l = p.length, f = {};
            for (var g = 0; g < l; g++) {
                var n = k.copy(p[g]);
                var c = n.part;
            ...
            m.events.push("outline-prebuild", {id: p[0].parent, insertChild: true});
            if (d == null) {
                m.messageSource.send.call(m, "addSummary", {content: p, parts: f});
                k.selectOne.call(m, p[0])
            }
        },
        removeSummary: function (A, r, D) {
            var g = this, c = g.model, u = g.currentRoot || c.topic, y = c.groupList, a = g.util, o = g.line,
                l = g.styles;
            var F = l.marginH, q = l.marginW;
            var E = [], t = {}, r = r || {}, k = "";
            ...
            if (D == null) {
                g.messageSource.send.call(g, "deleteSummary", {content: A, index: t, parts: r})
            }
            g.connection.resetAllConnectionPos.call(g, u);
            g.events.push("outline-prebuild", {id: A[0].parent, insertChild: true})
        }
        ...
        var a = e.util, c = e.designer, b = e.model, t = e.operation, s = b.topic, g = e.styles;
        var l = $("#" + r.id);
        if (l.length > 0) {
            l.parent().remove()
        }
        var d = s.structure == "mind_org", o = s.structure == "mind_tree";
        var u = r.title.replace(/\n/g, "<br>").replace(/\&lt;br\&gt;/g, "<br>"), k = "", p = g.childMarginH;
        if (d) {
            k = "org";
            p = 20
        } else {
        ...
        if (!r.root && r.parent != s.id) {
            ...
            var n = $("#" + r.parent).parent(), h = n.children("." + f);
            if (h.length == 0) {
                h = $("<div class='" + f + "'></div>");
                var m = 0;
                if (!d && !o) {
        ...
        if (f.length == 1) {
            ...
            return {part: c, startY: d.y, endY: d.y + d.h, startX: d.x + d.w}
        }
    }, isExists: function (b) {
        var h = this, g = h.model, f = g.groupList, m = f.freeList;
        var d = false;
        for (var c = 0, k = m.length; c < k; c++) {
            var e = m[c], l = e.target;
        ...
        var f = this, c = f.model, b = f.util, n = f.currentRoot || c.topic, g = f.operation, a = g.zoomVal / 100;
        var p = b.getTopicDom(j.id).parent();
        var k = b.getTopicDom(j.parent).parent(), h = k.children(".topic-children");
        var s = 0, q = 0;
        if (h.length > 0) {
        ...
        var d = e.model, a = e.util, p = e.currentRoot || d.topic, h = [];
        ...
        var h = this, g = h.util, f = h.model, l = h.summary, n = h.line;
        var m = [];
        for (var d = 0; d < j; d++) {
            var e = a[d];
            var k = e.target;
        ...
        var g = this, e = g.util, d = g.model, k = g.currentRoot || d.topic, j = g.summary;
        if (b.join(",").indexOf(k.id) >= 0) {
            return
        }
        var f = j.getSummaryChunk(g, b), h = f.length;
        if (h == 0) {
            return
        }
        var a = {};
        for (var c = 0; c < h; c++) {
            var l = f[c];
            l = $.extend(l, {title: "姒傝", children: [], summary: true, id: d.newId()});
        ...
        var i = this, g = i.model, k = i.currentRoot || g.topic, h = i.util;
        ...
        if (c == null) {
            f.children = [];
            e.children = [];
            i.messageSource.send.call(i, "updateSummary", {content: f, original: e, part: b})
        }
    }, renderSummaryOp: function (i, h, c) {
        var k = this, l = k.summary;
        if (i.summary) {
            $(".summary-dot").hide();
            ...
            if (e.children(".topic-children").length > 0) {
                ...
                var f = e.children(".topic-box");
                m = {x: f.position().left - 3, y: f.position().top - 3, w: f.outerWidth(), h: f.outerHeight()}
            }
            $(".topic-summary-resize").remove();
            var j = $('<div class="topic-summary-resize"><span></span><span></span></div>').appendTo(e);
            j.css({left: m.x, top: m.y, width: m.w, height: m.h});
            l.resizeEvent(k, i)
        } else {
            $(".topic-summary-resize").remove()
        }
    }, getSummaryD: function (t, s, h, n) {
        var l = this, k = l.summary;
        var q = t.range + "", j = {};
        if (q.indexOf(",") < 0) {
        ...
        var C = Math.floor((j.minY + j.maxY) / 2), i = Math.floor(j.x - 22), r = Math.floor(j.x - 12),
            g = Math.floor(j.x - 2);
        if (h) {
            switch (f) {
                default:
                    var p = Math.floor(j.x), u = Math.floor(j.x1);
                    var o = Math.floor(j.maxY + 10), c = o + 20;
            ...
            switch (f) {
                case"straight":
                    ...
                    var B = a - 18, z = a, w = Math.floor(j.minY), v = Math.floor(j.maxY), b = Math.floor((w + v) / 2),
                        e = a - 9;
                    if (s == "left") {
                        B = a + 18;
                        e = a + 9;
                    ...
                    break;
                case"curve":
                    var B = Math.floor(j.x) - 22, z = B - 2, w = Math.floor(j.minY), v = Math.floor(j.maxY),
                        b = Math.floor((w + v) / 2), e = B + 15;
                    if (s == "left") {
                        var a = Math.floor(j.x);
                        z = a + 22, B = a + 2, e = a + 6;
                        A.push(" M " + z + " " + w);
        ...
        var h = this, c = h.model, b = h.util, n = h.styles.childMarginH;
        var p = h.model.topic, f = (p.structure == "mind_org"), g = h.summary;
        if (j == null) {
        ...
        $(".topic-summary-resize").children("span").off().on("mousedown.summary", function (k) {
            var j = $(this), f = j.index();
            console.log("resize mousedown:" + f);
            var i = a.getParentTopic(c.parent), g = i.children, d = g.length;
            var l = k.pageY;
        ...
        var i = this, g = i.model, h = i.util, d = i.summary;
        var j = g.getTopicById(c), a = j.style;
        var e = $(".mind-summary-menu");
        e.find(".active").removeClass("active");
        var f = d.model.styles.lineColor, b = d.model.styles.lineWidth, k = d.model.styles.lineType;
        if (a != null) {
            if (a.lineColor != null) {
                f = a.lineColor
            }
        ...
        e.find("div[alt]").children().off("click").on("click", function (q) {
            var o = $(this), s = o.parent(), t = o.attr("ac");
            var p = s.attr("alt");
            ...
            if (p == "width") {
                ...
                r.style = $.extend(l, {lineWidth: t})
            } else {
                if (p == "color") {
                    if (l.lineColor == t) {
                        return
                    }
                    r.style = $.extend(l, {lineColor: t})
                } else {
                    if (p == "type") {
                        if (l.lineType == t) {
                            return
                        }
                        r.style = $.extend(l, {lineType: t})
                    }
                }
            }
...
mindDesigner.prototype.connection = {
    currentLine: null, tempLine: null, loadConnections: function (d) {
        var i = this, h = i.model, k = h.topic, p = k.lines, g = i.connection;
        if (d != null) {
            p = d
        }
        if (p == null) {
        ...
        for (var c in p) {
            ...
            if (n.points != null && n.points.length == 0 && n.realStart != null) {
                n.points.push({
                    x: (n.realStart.x + n.realEnd.x) / 2,
                    y: (n.realStart.y + n.realEnd.y) / 2
                }, {x: (n.realStart.x + n.realEnd.x) / 2, y: (n.realStart.y + n.realEnd.y) / 2})
            }
            if (n.pts == null && n.points.length > 0) {
                n.pts = [{x: 0, y: 0}, {x: 0, y: 0}];
        ...
        if (o) {
            $.ajax({
                ...
                type: "post",
                data: {id: i.opts.chartId, def: JSON.stringify(k), ignore: "def"},
                success: function (q) {
                },
                error: function () {
                }
        ...
        var a = l.realStart, c = l.realEnd, k = l.points;
        var h = [];
        ...
        var f = this, e = f.util, d = f.model, b = f.connection, j = f.styles, h = h || e.getSelectedId();
        var k = $.extend(true, {styles: j.connectionStyle}, {id: d.newId()});
        var c = e.getRealPos.call(f, i.pageX, i.pageY);
        var g = b.getPointInSVG(f, a, c);
        k.start = g;
        k.realEnd = c;
        k.realStart = {x: a.x, y: a.y};
        ...
        var a = {};
        if (c.x < g.x && c.y > g.y) {
            return {x: b, y: f - 10, w: e - b + 10, h: d - f + 10, start: {x: e - b, y: 10}, end: {x: 10, y: d - f}}
        } else {
            if (c.x < g.x && c.y < g.y) {
                return {x: b, y: f, w: e - b + 10, h: d - f + 10, start: {x: e - b, y: d - f}, end: {x: 10, y: 10}}
            } else {
                if (c.x > g.x && c.y < g.y) {
                    return {
                        x: b - 10,
        ...
        return {x: b - 10, y: f - 10, w: e - b + 10, h: d - f + 10, start: {x: 10, y: 10}, end: {x: e - b, y: d - f}}
    }, getSvgPos: function (e, j, h, d) {
        var f = {x: j.x - j.w / 2, y: j.y - j.h / 2, w: j.w, h: j.h};
        var b = {x: e.x - e.w / 2, y: e.y - e.h / 2, w: e.w, h: e.h};
        var i, g, c, a;
        if (b.x <= f.x) {
            i = b.x
        } else {
        ...
        var k = {x: i, y: g, w: c - i, h: a - g};
        return k
    }, resetConnectionsOnMoving: function (e) {
        var g = this, f = g.util, d = g.connection;
        for (var a in e) {
            var k = e[a];
            ...
            k.end = h;
            k.realStart = {x: b.x - b.w / 2 + b.w * i.x, y: b.y - b.h / 2 + b.h * i.y};
            k.realEnd = {x: c.x - c.w / 2 + c.w * h.x, y: c.y - c.h / 2 + c.h * h.y};
        ...
        var l = this, c = p.lines, f = l.model;
        ...
        var b = l.util, j = l.connection;
        for (var o in c) {
            var m = c[o], a = m.canvasPos;
            ...
            var q = m.points, i = {x: t.x - t.w / 2 + m.start.x * t.w, y: t.y - t.h / 2 + m.start.y * t.h},
                d = {x: h.x - h.w / 2 + m.end.x * h.w, y: h.y - h.h / 2 + m.end.y * h.h};
            m.realStart = i;
            m.realEnd = d;
            if (q != null && q.length > 0) {
                ...
                if (v.length == 0) {
                    ...
                    q[0] = {x: v[0].x + t.x, y: v[0].y + t.y};
                    q[1] = {x: v[1].x + h.x, y: v[1].y + h.y}
                }
            }
            var n = {};
            if (q.length == 0) {
                n = {x: (d.x + i.x) / 2, y: (d.y + i.y) / 2}
            } else {
                n = {x: q[1].x, y: q[1].y}
            }
            var r = {x: d.x, y: d.y};
        ...
        var j = this, b = j.util, f = j.model, i = b.getSelectedId(), h = j.connection, l = j.styles, m = j.operation,
            a = m.zoomVal / 100;
        if (i == 0) {
            return
        }
        ...
        j.designer.off("mousemove.connection").on("mousemove.connection", function (v) {
            if ($(".mind-tip").length == 0) {
                $.showTip("鐐瑰嚮鍏朵粬涓婚锛屽嵆鍙缃叧鑱旇繛绾�", null)
            }
            ...
            n.start = e;
            n.realStart = {x: t.x - t.w / 2 + t.w * e.x, y: t.y - t.h / 2 + t.h * e.y};
            h.setConnectionD(n)
        });
        j.designer.off("mouseup.connection").on("mouseup.connection", function (y) {
            ...
            if (x.hasClass("topic") || x.hasClass("topic-box")) {
                ...
                n.end = z;
                n.realEnd = {x: u.x - u.w / 2 + u.w * z.x, y: u.y - u.h / 2 + u.h * z.y};
        ...
        var b = m.realEnd, l = m.styles, a = m.angle, i = l.lineType, e = l.lineWidth;
        ...
        var g = {x: c.x, y: c.y - c.h / 2};
        var d = {x: c.x, y: c.y + c.h / 2};
        var e = {x: c.x + c.w, y: c.y - c.h / 2};
        var a = {x: c.x + c.w, y: c.y + c.h / 2};
        if (f.x < g.x && f.y < g.y) {
            k.x = f.x;
            k.y = f.y;
            k.w = g.x + c.w - f.x;
        ...
        var f = h.util, a = h.connection, e = a.currentLine;
        var k = f.getTopicRealPos.call(h, e.from), i = f.getTopicRealPos.call(h, e.to);
        var g = {x: k.x + k.w / 2, y: k.y, w: k.w, h: k.h};
        var c = {x: i.x + i.w / 2, y: i.y, w: i.w, h: i.h};
        var d = document.getElementById("line_" + e.id);
        var j = h.designer;
        var b = f.copy(e);
        j.off("mousedown.points").on("mousedown.points", ".connection_point", function (s) {
            var q = $(this), v = s.pageX, u = s.pageY, r = h.operation, B = r.zoomVal / 100;
            var o = $(".connection_point[tp=from]"), l = $(".connection_point[tp=to]"),
                t = $(".mind-connection-con[conn=" + e.id + "]"), A = t.find(".mind-connection-label"), p, z, w;
            ...
            h.util.clearSelect();
            a.currentLine = e;
            var n = q.position().left + q.width() / 2, m = q.position().top + q.height() / 2;
            j.off("mousemove.points").on("mousemove.points", function (C) {
                var y = C.pageX, x = C.pageY, I = y - v, H = x - u;
                if (Math.abs(I) > 2 || Math.abs(H) > 2) {
                    ...
                    if (G == "from") {
                        ...
                        e.start = F;
                        e.realStart = {x: g.x - g.w / 2 + g.w * F.x, y: g.y - g.h / 2 + g.h * F.y};
                        e.points[0] = {x: E.x, y: E.y};
                        e.points[1] = {x: w.x, y: w.y};
                        p = f.getAngle({x: w.x, y: w.y}, c)
                    } else {
                        p = f.getAngle(E, c);
                        var D = a.getPointInSVG(h, c, E);
                        e.end = D;
                        e.realEnd = {x: c.x - c.w / 2 + c.w * D.x, y: c.y - c.h / 2 + c.h * D.y};
                        e.points[1] = {x: E.x, y: E.y};
                        e.points[0] = {x: z.x, y: z.y}
                    }
                    e.pts = [];
                    e.pts[0] = {x: e.points[0].x - g.x, y: e.points[0].y - g.y};
                    e.pts[1] = {x: e.points[1].x - c.x, y: e.points[1].y - c.y};
                    e.angle = p;
                    a.setConnectionD(e);
                    a.renderArrow(h, e);
        ...
        $(".mind-connection-menu").find("div[alt]").children().off("click").on("click", function (p) {
            var n = $(this), q = n.parent(), r = n.attr("ac");
            var o = q.attr("alt");
            var t = a.currentLine;
            if (t == null) {
                return
            ...
            if (o == "width") {
                ...
                t.styles = $.extend(s, {lineWidth: r})
            } else {
                if (o == "color") {
                    if (s.lineColor == r) {
                        return
                    }
                    t.styles = $.extend(s, {lineColor: r})
                } else {
                    if (o == "type") {
                        if (s.lineType == r) {
                            return
                        }
                        t.styles = $.extend(s, {lineType: r})
                    } else {
                        if (o == "arrow") {
                            if (s.lineArrow == r) {
                                return
                            }
                            t.styles = $.extend(s, {lineArrow: r})
                        }
                    }
                }
            }
        ...
        var d = f.children(".mind-connection-label"), c = f.children(".mind-connection-label-icons");
        if (a.label) {
            d.html(a.label)
        }
        ...
        a.css({left: b.x, top: b.y, background: c.styles.lineColor, color: c.styles.color})
    }, renderConnControls: function (f, e) {
        var n = f.designer, c = f.connection, l = e.points, g = e.canvasPos, b = e.realStart, d = e.realEnd;
        var j = {x: (b.x + d.x) / 2, y: (b.y + d.y) / 2};
        ...
        var f = h.util, b = h.connection, e = e || b.currentLine, n = e.styles;
        var o = $(".connection_line[tp=" + l + "]"), m = $(".connection_point[tp=" + l + "]"), g = 0;
        m.css({left: j.x, top: j.y, border: "1px solid " + n.lineColor});
        var a = e.realStart;
        var d = e.realEnd;
        var k, i, c;
        if (l == "from") {
        ...
        var f = b.points, c = [];
        var g = b.realStart, a = b.realEnd;
        if (f.length == 0) {
            var e = (a.x + g.x) / 2;
            var d = (a.y + g.y) / 2;
            c = [{x: e, y: d}, {x: e, y: d}]
        } else {
            c = [{x: f[0].x, y: f[0].y}, {x: f[1].x, y: f[1].y}]
        }
        return {
        ...
        var d = this, g = d.model.topic, b = g.lines, c = d.connection;
        var e, j = [];
        for (var a in b) {
            var i = b[a];
            e = c.pointInConnection({x: h, y: f}, i, 7);
            if (e > 0) {
                j.push(i);
                break
            }
        }
        return {inline: e, lines: j}
    }, pointInConnection: function (h, m, e) {
        var j = this.getConnectionPoints(m), f = j.length;
        var c = {x: h.x - e, y: h.y};
        var b = {x: h.x + e, y: h.y};
        var a = {x: h.x, y: h.y - e};
        var l = {x: h.x, y: h.y + e};
        ...
        var h = [];
        var a = k.points, j = {};
        var c = k.realStart, e = k.realEnd;
        if (a.length == 0) {
            var g = (e.x + c.x) / 2;
            var f = (e.y + c.y) / 2;
            j = [{x: g, y: f}, {x: g, y: f}]
        } else {
            j = [{x: a[0].x, y: a[0].y}, {x: a[1].x, y: a[1].y}]
        }
        var d = 0.05;
        var i = 0;
        while (i <= 1) {
        ...
        return {x: h.toFixed(1), y: g.toFixed(1), index: e}
    }, getConnectionsByTopic: function (b) {
        var h = this, e = h.model, j = e.topic, m = j.lines, f = h.util, c = h.connection;
        ...
        if (e == null) {
            d.messageSource.send.call(d, "addConnection", {content: a})
        }
    }, updateConnection: function (c, b, a, d) {
        this.saveConnection(c, b);
        if (d == null) {
            c.messageSource.send.call(c, "updateConnection", {content: b, original: a})
        }
    }, saveConnection: function (d, c) {
        var b = d.model, a = b.topic;
        if (a.lines == null) {
            a.lines = {}
        }
        a.lines[c.id] = c
    }, saveConnectionText: function (e, c, b) {
        var d = e.model, a = d.topic;
        a.lines[c.id] = c;
        e.messageSource.send.call(e, "updateConnection", {content: c, original: b})
        ...
        var e = f.model, h = e.topic, j = h.lines;
        ...
        this.currentLine = null;
        if (a == null) {
            f.messageSource.send.call(f, "deleteConnection", {content: b})
        }
    }, deleteConnectionByTopics: function (b, k) {
        var l = this, h = l.model, m = h.topic, d = l.connection, n = m.lines;
        ...
        var f = h.model, c = f.topic, b = c.lines;
        ...
        var f = [], h = k.model, l = h.topic, m = l.lines, d = this;
        if (m == null) {
            return
        }
        for (var e = 0, j = b.length; e < j; e++) {
...
mindDesigner.prototype.virtualTopic = {
    setMovingRelated: function (h, o) {
        ...
        var a = $("#" + h.id), c = a.siblings(".topic-children"), d = a.siblings(".topic-children-summary");
        var b = a.parent();
        ...
        if (o != null) {
            var k = 0, l = o.children.concat(o.summaries || []);
        ...
        var f = this, h = f.virtualTopic, c = f.model, b = f.currentROot || c.topic, a = f.util,
            e = f.operation.zoomVal / 100;
        f.designer.off("mousemove.dragmove1").on("mousemove.dragmove1", ".topic-insert", function (l) {
            var j = $(this), k = j.parent(), o = k.attr("id");
            if (o == b.id) {
                var i = j.width(), m = j.offset();
                if (l.offsetX < i / 2) {
                    var n = {x: m.left, y: m.top + j.height() / 2 * e - 13, weizhi: "in"};
                    g.pos = "in";
                    h.renderShape(b, n, "left", null, b.id);
                    g.rootPos = "left"
                } else {
                    var n = {x: m.left + k.outerWidth() * e, y: m.top + j.height() / 2 * e - 13, weizhi: "in"};
                    g.pos = "in";
        ...
        f.designer.off("mouseenter.dragmove").on("mouseenter.dragmove", ".topic-insert", function (o) {
            var n = $(this), m = n.parent(), i = m.attr("id");
            if (i == d.id) {
                return
            }
...
mindDesigner.prototype.model = {
    ...
    topicDef: {id: "root", root: true, title: "涓績涓婚", children: [], structure: "mind_right", theme: "theme3"},
    topic: {
        id: "root1",
        root: true,
        title: "涓績涓婚",
    ...
    clipboard: {type: "copy", list: []},
    persistenTopic: {},
    topicList: {
        parentTopics: {}, data: {}, build: function (b) {
            var g = this;
            g.data[b.id] = b;
            var d = b.children, a = d.length;
            if (a > 0) {
                for (var c = 0; c < a; c++) {
                    var h = d[c];
                    g.build(h)
            ...
            var b = this.model, c = b.topicList;
            var a = b.topic;
            c.data = {};
            c.build(a)
        }
    ...
    groupList: {
        leftList: [], rightList: [], freeList: [], justPos: "right", justTopic: null, doGroup: function (c, b) {
            var f = this;
            f.clearData();
            f.leftList = [];
            f.rightList = [];
            var e = c.children, a = e.length;
            for (var d = 0; d < a; d++) {
                var g = e[d];
                f.setList(g, b)
            }
    ...
    getNewTopicIndex: function (c, e, d, b) {
        var a = 0, h = this.groupList, g = h.rightList, f = h.leftList;
        if (c.root && b == "right") {
            return g.length
        } else {
            if (c.root && b == "left") {
    ...
    getTopicDomProp: function (b) {
        ...
        return {h: a.outerHeight(), w: a.outerWidth(), x: a.position().left, y: a.position().top}
    },
    getNearTopic: function (o, n) {
        var m = this, h = m.model, p = m.currentRoot || h.topic, r = p.structure == "mind_org", j = m.util;
        var e = j.getSelectedId();
        if (e == "") {
            return null
        }
        var g = h.getTopicById(e), d = j.getSelectedPart(e, p.structure);
        if (o == "left") {
            if (r) {
                var q = h.getParentTopic(g.parent), c = q.children;
                if (c.length > 1) {
                    var l = 0;
    ...
    getPrevTopic: function (f, c) {
        var g = 0, j = this.getParentTopic(f.parent);
        var b = j.children;
        if (j.root && c == "left") {
            b = j.leftChildren
        }
    ...
    getNextTopic: function (d, c) {
        var b = 0;
        var g = this.getParentTopic(d.parent), f = g.children;
        if (g.root && c == "left") {
            f = g.leftChildren
        }
        var a = f.length;
    ...
    getPreTopic: function (c) {
        ...
        var b = 0;
        var f = this.getParentTopic(c.parent), e = f.children, a = e.length;
        for (var d = 0; d < a; d++) {
            var g = e[d];
            if (g.id == c.id) {
                b = d - 1;
    ...
    getParentTopicPos: function (b) {
        ...
        return {x: a.position().left + a.outerWidth() / 2, y: a.positon().top + a.outerHeight() / 2}
    },
    getParentTopics: function (g, a, e) {
        var c = this.getTopicById(g), d = this;
        var f = [];
        if (a) {
            f.push(c)
        }
    ...
    getParentTopicIds: function (e) {
        var c = this, b = c.getParentTopicById(e);
        var d = [];
        a(b);
    ...
    changeTopicExpand: function (d, e, c, g) {
        var f = this, b = f.model, a = b.topic;
        if (g == null) {
            f.messageSource.send.call(f, "changetopicexpand", {content: d.id, type: e, part: c})
        }
    },
    addTopicMulti: function (v, g, o, x) {
        ...
        var h = this, c = h.model, s = h.currentRoot || c.topic, e = (s.structure == "mind_org"), f = s.leftChildren,
            a = h.util, k = h.line, b = "", p = h.messageSource;
        var y = [], j = "";
        for (var u = 0, w = v.length; u < w; u++) {
            var r = v[u], l = g[r.id], q = o[r.id];
        ...
        if (x == null) {
            p.send.call(h, "create", {content: v, index: g, parts: o})
        }
        h.connection.resetAllConnectionPos.call(h, s);
        h.events.push("outline-prebuild", {id: v[0].parent, rebuild: "current"})
    },
    updateFreeTopicPos: function (f, i, l, a, b) {
        var h = this, g = h.model, j = h.currentRoot || g.topic, e = h.util, c = h.connection;
        var d = e.copy(f.pos);
        f.pos = i;
        g.topicList.resetTopicList.call(h);
        var k = e.getTopicContainer(f.id);
        k.css({left: i.x, top: i.y});
        if (l == null) {
    ...
    addFreeTopic: function (c, h, e, f) {
        var b = e.util, d = e.model, a = d.topic, g = d.groupList;
        c.free = true;
        c.pos = {x: h.x, y: h.y};
        a.children.push(c);
        ...
        e.renderTopicDom(c);
        e.events.push("outline-prebuild", {id: "root", insertChild: true});
        if (f == null) {
            e.messageSource.send.call(e, "addFreeTopic", {content: c});
            b.selectOne.call(e, c)
        }
    },
    changeToFreeTopic: function (B, l, H) {
        var n = this, c = n.model, A = c.topic, D = c.groupList, r = n.line, a = n.util, o = n.styles;
        var J = o.marginH, v = o.marginW, I = [], K = a.copy(B);
        ...
        if (j.id == B.id) {
            ...
            n.range.doChangeSubTopicPos(n, j, -G / 2, q, y)
        } else {
        ...
        I.push(j.id);
        var p = c.getTopicById(B.parent), g = p.children;
        if (p.root && y == "left") {
            g = p.leftChildren
        }
        var F = g.length, m = 0;
        ...
        g.splice(m, 1);
        if (g.length == 0) {
            var E = a.getTopicDom(p.id);
            E.find(".expand_box").remove()
        }
        K.parent = A.id;
        A.children.push(K);
        K.free = true;
        K.pos = {x: l.x, y: l.y};
        D.doGroup(A, A.structure);
        c.topicList.resetTopicList.call(n);
        r.resetLines.call(n, I, null, y);
        n.renderSubTopic(K);
        var d = a.getTopicContainer(K.id);
        var t = d.children(".topic-box");
        var z = {}, f = (A.structure == "mind_org"), x = (A.structure == "mind_tree");
        if (f) {
            z = {x: d.outerWidth() / 2, y: t.outerHeight(), h: t.outerHeight()}
        } else {
            if (x) {
                z = {x: 10, y: t.outerHeight(), h: t.outerHeight()}
            } else {
                z = {x: t.outerWidth(), y: d.outerHeight() / 2 - 0.5, h: t.outerHeight()}
            }
        }
        r.renderLines.call(n, K, z);
        if (H == null) {
            a.selectOne.call(n, K);
            n.messageSource.send.call(n, "changeToFreeTopic", {content: K, original: B.parent, index: m, part: y})
        }
        n.connection.resetAllConnectionPos.call(n, A);
        n.events.push("outline-prebuild", {id: "root", rebuild: "current"})
    },
    ...
    unInsertParentTopic: function (o, l, m, r) {
        var g = this, d = g.model, n = g.currentRoot || d.topic, q = d.groupList, a = g.util, i = g.line, h = g.styles;
        ...
        if (r == null) {
            ...
            p.children = [];
            j.children = [];
            g.messageSource.send.call(g, "unInsertParent", {content: j, original: p, part: m})
        }
        g.connection.resetAllConnectionPos.call(g, n)
    },
    insertParentTopic: function (m, j, k, q) {
        var f = this, c = f.model, l = f.currentRoot || c.topic, o = c.groupList, a = f.util, h = f.line, g = f.styles;
        var i = c.getTopicById(m.parent);
        var r = g.marginH;
        k = k || a.getSelectedPart(m.id, l.structure);
        var d = i.children, e = 0;
        if (i.root && k == "left") {
            d = i.leftChildren
        }
        if (j == null) {
        ...
        if (q == null) {
            ...
            n.children = [];
            s.children = [];
            f.messageSource.send.call(f, "insertParent", {content: s, original: n, part: k})
        }
        f.connection.resetAllConnectionPos.call(f, l);
        f.events.push("outline-prebuild", {id: i.id, rebuild: "current"})
    },
    replaceDef: function (b, a) {
        that.messageSource.send.call(that, "replaceDef", {content: b, original: a})
    },
    updateTopicText: function (n, s, r) {
        var g = this, b = g.model, a = g.util, k = g.line, m = g.currentRoot || b.topic, o = b.groupList;
        var i = n.title;
        n.title = s;
        var e = b.getSubTopic(n);
        var l = a.getSelectedPart(n.id, m.structure);
        var c = a.getTopicContainerProp(e.id);
        var q = a.getTopicDom(n.id), d = q.find(".topic");
        d.html(s).show();
        ...
        if (r == null) {
            g.messageSource.send.call(g, "updateTitle", {content: n.id, original: i, update: s, part: l})
        }
        ...
        a.resetSelectDom();
        g.events.push("outline-prebuild", {id: n.id, rebuild: "current"})
    },
    updateTopicImage: function (q, b, x, w) {
        var s = 900, d = 0;
        var i = this, e = i.model, a = i.util, k = i.line, p = i.currentRoot || e.topic, r = e.groupList,
            n = i.messageSource;
        var t = a.getTopicDom(q.id);
        var g = e.getSubTopic(q);
        var o = a.getSelectedPart(g.id, p.structure);
        var f = a.getTopicContainerProp(g.id);
        var l = q.image, m = $("#topic_img_" + q.id), v = m.parent();
        var j = false;
        if (x) {
        ...
        function h() {
            ...
            v.css({width: s, height: d});
            m.css({width: s, height: d})
        }
        ...
        function u() {
            ...
            if (w == null) {
                n.send.call(i, "updateImage", {content: q.id, update: C, original: z, resize: j, part: o})
            }
    ...
    updateTopicNode: function (p, b, d, t, u) {
        var j = this, e = j.model, o = j.currentRoot || e.topic, v = j.operation, a = j.util, m = j.line,
            q = e.groupList;
        p = a.copy(p);
        b = a.copy(b);
        ...
        b.children = [];
        if (u == null) {
            j.messageSource.send.call(j, "update", {content: p, original: b, type: d, part: n})
        }
    },
    _updateTopicPos: function (J, E, s, A, L, a, R) {
        var F = this, d = F.model, z = F.currentRoot || d.topic, q = d.groupList, m = F.util, n = F.line, C = F.styles;
        var u = C.marginH, k = C.marginW;
        var r = [], P = "";
        ...
        F.events.push("outline-prebuild", {id: "root", rebuild: "current"})
    },
    updateTopicPos: function (T, a, t, G) {
        var P = this, f = P.model, H = P.currentRoot || f.topic, v = f.groupList, q = P.util, r = P.line, L = P.styles;
        var A = L.marginH, o = L.marginW;
        var x = [], B = [], y = [], N = {}, I = {}, Y = "", U = {}, b = {};
        ...
        P.events.push("outline-prebuild", {id: "root", rebuild: "current"})
    },
    addAndRemove: function (F, q, m, s, x, G) {
        var k = this, d = k.model, y = k.currentRoot || d.topic, D = d.groupList, a = k.util, p = k.line, n = k.styles;
        var I = n.marginH, r = n.marginW;
        var A = [], H = [], l = "";
        var f = {};
        for (var K in q) {
            var C = q[K];
    ...
    removeAndAdd: function (z, o, h, p, A) {
        var g = this, c = g.model, u = g.currentRoot || c.topic, a = g.util, n = g.line, l = g.styles;
        var t = {}, B = [], k = "";
        if (z.length > 0) {
    ...
    removeTopic: function (B, F) {
        ...
        var g = this, c = g.model, x = g.currentRoot || c.topic, z = c.groupList, a = g.util, o = g.line, l = g.styles;
        var H = l.marginH, q = l.marginW;
        var G = [], v = {}, s = {}, k = "", E = B.length;
        ...
        if (F == null) {
            g.messageSource.send.call(g, "delete", {content: B, index: v, parts: s})
        }
        g.connection.resetAllConnectionPos.call(g, x);
        g.events.push("outline-prebuild", {id: B[0].parent, rebuild: "current"})
    },
    hideTopics: function (o, t, u) {
        var g = this, a = g.util, c = g.model, h = g.line, p = g.currentRoot || c.topic;
        var n = "", s = [], m = {}, k = [];
        if (o.length > 0) {
            if (t) {
                ...
                var d = a.getTopicDom(e.id), v = d.children(".expand_box");
                ...
                for (var r = 0; r < o.length; r++) {
                    ...
                    q.collapsed = true;
                    s.push(q);
                    var d = a.getTopicDom(l), v = d.children(".expand_box");
                    v.html("&#xe647;").addClass("hide")
                }
            }
            if (s.length == 0) {
            ...
            if (u == null) {
                g.messageSource.send.call(g, "hideTopics", {ids: k, parts: m, withChildren: t})
            }
    ...
    showTopics: function (n, s, t) {
        var g = this, a = g.util, c = g.model, h = g.line, o = g.currentRoot || c.topic;
        var m = "", r = [], l = {}, j = [], u = [];
        if (n.length > 0) {
            if (s) {
                ...
                for (var q = 0; q < n.length; q++) {
                    ...
                    g.renderSubTopic(e, f);
                    var d = a.getTopicDom(k), v = d.children(".expand_box");
            ...
            if (t == null) {
                g.messageSource.send.call(g, "showTopics", {ids: j, parts: l, withChildren: s})
            }
    ...
    copying: false,
    doCopy: function (a) {
        var h = this, g = h.util, f = h.model, k = h.currentRoot || f.topic, d = f.clipboard;
        if (f.copying) {
            return
        }
        f.copying = true;
    ...
    doCut: function (a) {
        var k = this, h = k.util, g = k.model, m = k.currentRoot || g.topic, f = g.clipboard;
        if (g.copying) {
            return
        }
        g.copying = true;
    ...
    doPaste: function (j) {
        var h = this, d = h.model, m = h.currentRoot || d.topic, s = d.clipboard, c = s.type, t = s.list, a = h.util;
        if (d.copying) {
            return
        }
        d.copying = true;
...
mindDesigner.prototype.util = {
    selectedIds: [], select: function (a) {
        ...
        a.css({width: b.outerWidth() + 3, height: b.outerHeight() + 3})
        ...
        var g = this, e = g.model, d = g.util.selectedIds;
        var b = false;
        ...
        var b = $("#" + d).parent(), c = b.position();
        if (b.length == 0) {
            return null
        }
        return {h: b.outerHeight(), w: b.outerWidth(), x: c.left / (a || 1), y: c.top / (a || 1)}
        ...
        var a = c.parent();
        var d = a.position();
        return {h: a.outerHeight(), w: a.outerWidth(), x: d.left / b, y: d.top / b, dom: a}
    }, getSubTopicDomProp: function (f, a, c) {
        var d = $("#" + f);
        var b = d.parent();
        var e = b.position();
        if (a == "mind_org") {
            return {x: e.left / c + b.outerWidth() / 2, y: e.top / c, w: d.outerWidth(), h: d.outerHeight()}
        } else {
            if (a == "mind_tree") {
                return {x: e.left / c + d.outerWidth() / 2, y: e.top / c, w: d.outerWidth(), h: d.outerHeight()}
            }
        }
        return {h: b.outerHeight(), w: b.outerWidth(), x: e.left / c, y: e.top / c + b.outerHeight() / 2}
    }, getTopicsByRange: function (m, a) {
        var j = $(".topic-box"), t = [], o = m.x + m.w, b = m.y + m.h, p = Math.max, n = Math.min;
        for (var q = 0, r = j.length; q < r; q++) {
            var k = $(j[q]), g = k.offset(), l = k.width(), s = k.height();
            var f = p(g.left / a, m.x), d = p(g.top / a, m.y), e = n((g.left + l) / a, o), c = n((g.top + s) / a, b);
            if (f < e && d < c) {
                t.push(k.attr("id"))
            }
        }
        ...
        var g = this, i = g.model.topic;
        var e = $(".topic-box[id=" + i.id + "]"), h = e.position(), c = e.offset();
        var d = h.left - c.left;
        var b = h.top - c.top
    }, getTopicRealPos: function (o, r) {
        var i = this, d = i.model, l = i.container, k = i.operation, a = k.zoomVal / 100, b = i.util;
        var q = $("#" + o), h = q.position(), f = h.left, n = h.top;
        if (q.attr("sub")) {
            var j = q.parent(), e = j.position(), m = e.left, p = e.top;
            if (r == "mind_org") {
                return {x: m + q.outerWidth() / 2, y: (p + n) / a, w: q.outerWidth(), h: q.outerHeight()}
            }
            return {x: (m + f) / a, y: (p + n) / a + q.outerHeight() / 2, w: q.outerWidth(), h: q.outerHeight()}
        } else {
            var c = d.getTopicById(o);
            var g = d.getSubTopic(c);
            var j = $("#" + g.id).parent(), e = j.position(), m = e.left, p = e.top;
            if (r == "mind_org") {
                return {x: (f + m) / a + q.outerWidth() / 2, y: (n + p) / a, w: q.outerWidth(), h: q.outerHeight()}
            }
            return {x: (f + m) / a, y: (p + n) / a + q.outerHeight() / 2, w: q.outerWidth(), h: q.outerHeight()}
        }
    }, getRealPos: function (h, g) {
        var f = this, a = f.container, d = f.operation, i = d.zoomVal / 100;
        var b = a.scrollLeft();
        var c = a.scrollTop();
        if (i == 1) {
            return {x: b + h, y: c + g}
        ...
        return {x: Math.abs(e.left) / i + h / i, y: Math.abs(e.top) / i + g / i}
    }, getChildTopicRelativePos: function (f, a) {
        var d = $(".topic-box[id=" + f + "]"), e = d.position(), c = e.left, b = e.top;
        return {x: c / a, y: Math.floor(b / a + d.outerHeight() / 2), w: d.outerWidth(), h: d.outerHeight()}
    }, getTreeChildTopicRelativePos: function (f, a) {
        var d = $(".topic-box[id=" + f + "]"), e = d.position(), c = e.left, b = e.top;
        return {x: c / a, y: b / a + d.outerHeight(), w: d.outerWidth(), h: d.outerHeight()}
    }, getOrgChildTopicRelativePos: function (f, a) {
        var d = $(".topic-box[id=" + f + "]"), e = d.position(), c = e.left, b = e.top;
        return {x: c / a + d.outerWidth() / 2, y: b / a, w: d.outerWidth(), h: d.outerHeight()}
    }, getSubTopicRelativePos: function (d, a) {
        var c = $(".topic-box[id=" + d + "]"), b = c.parent().outerHeight() / 2 - 0.5;
        if (a == "mind_org") {
            return {x: c.parent().outerWidth() / 2 - 0.5, y: c.outerHeight(), w: c.outerWidth(), h: c.outerHeight()}
        } else {
            if (a == "mind_tree") {
                return {x: 0, y: c.outerHeight(), w: c.outerWidth(), h: c.outerHeight()}
            }
        }
        return {x: 0, y: b, w: c.outerWidth(), h: c.outerHeight()}
        ...
        if (s.structure == "mind" && (s.root == null || s.classic)) {
            s.leftChildren = [], e = s.children, q = e.length - 1;
            var g = Math.floor(q / 2), p = [];
            for (var o = g; o < q; o++) {
                var c = e[o];
                p.push(c)
            }
        ...
        function r(F) {
            if (F.tag != null) {
                var D = F.tag;
                var E = [];
                var G = {text: D, color: "#276F86", background: "#d6f0f8"};
                E.push(G);
                F.tags = E;
                delete F.tag
            }
        ...
        if (k || j) {
            $.ajax({
                url: "/mindmap/updatedef",
                type: "post",
                data: {id: h.opts.chartId, def: JSON.stringify(s), ignore: "def"},
                success: function (i) {
                },
                error: function () {
                }
...
mindDesigner.prototype.tags = {
    setTags: function (k) {
        var g = this, f = g.util, d = g.model, a = f.getSelectedId();
        if (g.opts.readonly) {
            return
        }
        ...
        var i = $.trim(k.text), e = d.getTopicById(a), h = e.tags;
        if (h == null) {
            e.tags = []
        }
        var c = false;
        ...
        var d = {background: "#d6f0f8", color: "#276F86"};
        var g = [];
        ...
        var h = this, f = h.util, d = h.model, a = f.getSelectedId();
        if (a == null || $.trim(a) == "") {
            return
        }
        var e = d.getTopicById(a), b = f.copy(e), j = e.tags;
        var g = 0;
        ...
        var k = this, h = k.util, f = k.model, a = h.getSelectedId();
        if (a == null || $.trim(a) == "") {
            return
        }
        var g = f.getTopicById(a), c = h.copy(g), l = g.tags || [];
        if (l.length == 0) {
            g.tags = [];
            g.tags.push({background: d.background, color: d.color, text: m})
        } else {
        ...
        var k = this, h = k.util, g = k.model, b = j || h.getSelectedId(), i = k.operation, c = k.tags;
        if (b == null || $.trim(b) == "") {
            return
        }
        if (k.opts.readonly) {
        ...
        var f = $("#mind-tags-box");
        if (f.length == 0) {
            f = $("<div id='mind-tags-box' class='mind-topic-box'><div class='mind-tags-curr'><div>褰撳墠鏍囩</div><div></div></div><div class='mind-tags-color'><div>鏍囩棰滆壊</div><div class='mt10'></div></div><div class='mind-tags-default'><div>鍙坊鍔犳爣绛�</div><div class='mt10'></div></div><div class='mind-tags-input'><input id='mind-topic-tag' type='text' placeholder='杈撳叆鏂囨湰锛屽洖杞︽柊寤烘爣绛�'/></div></div>").appendTo(k.designer)
        }
        e(f);
        c.renderTags(k, b);
        $.fn.showPanel({target: d, panel: f});
        f.find("input").focus();
        if (a != null) {
            c.selectTag(a)
        }
        ...
        function e(s) {
            ...
            var r = {background: "#d6f0f8", color: "#276F86"};
            var t = [];
            ...
            if (p.children().eq(1).children().length == 0) {
                var m = '<span class="tags" style="background:#7a00f2;">寰呭畾</span><span class="tags" style="background:#50c28b;">宸茬‘璁�</span><span class="tags" style="background:#6d6d6d;">宸插畬鎴�</span><span class="tags" style="background:#c4c4c4;">宸插叧闂�</span><span class="tags" style="background:#2760f2;">杩涜涓�</span>';
        ...
        if (j != null && j.length > 0) {
            ...
            g.children().eq(1).html("<span style='font-size:12px;color:#aaa;'>杩樻病鏈夋爣绛撅紝璇峰湪涓嬫柟杈撳叆鍚庡洖杞︽柊寤�</span>")
        }
        ...
        $(document).off("click.tags").on("click.tags", ".mind-tags-default .tags", function (k) {
            ...
            if (j.find(".tags").length > 4) {
                $.showTip("鍗曚釜鑺傜偣鏈€澶氭敮鎸�5涓爣绛�", 2000);
                return
            }
            var h = $("#mind-tags-box");
            var m = $(this), l = m.children("label").length > 0 ? m.children("label").text() : m.text();
            var i = a.checkExists(d, f, l);
            if (!i) {
                return
            }
            var g = {text: l, background: m.css("background-color"), color: m.css("color")};
            a.setTags.call(d, g);
            a.renderTags(d, f);
            a.selectTag(l);
            k.stopPropagation()
        ...
        $("#mind-tags-box").children(".mind-tags-color").find("span").off("click").on("click", function (j) {
            ...
            var h = {background: l.css("background-color"), color: l.css("color")};
        ...
        function b(l) {
            ...
            e(l);
            var h = {color: "#276F86", background: "#d6f0f8"};
            var k = {text: l, color: h.color, background: h.background};
            a.setTags.call(d, k);
            a.renderTags(d, f);
            $("#mind-topic-tag").val("");
            a.selectTag(l)
        ...
        $.fn.showPanel({target: b, panel: $("#mind-tags-box")})
    }
};
mindDesigner.prototype.remark = {
    setRemark: function (g, e) {
        var f = this, b = f.util, d = f.model, h = e || b.getSelectedId();
        if (f.opts.readonly) {
            return
        }
        if (h == null || $.trim(h) == "") {
        ...
        var d = new showdown.Converter({simpleLineBreaks: true, tables: true, tasklists: true});
        var g = a.htmlDecode(b.note);
        var c = d.makeHtml(g).replace(/<(\/)?script([^>]+)?>/g, "&lt;$1script$2&gt;");
        e = $("<div id='note_view_box'>" + c + "</div>").appendTo("body");
        e.dropdown({target: f, position: "center"});
...
mindDesigner.prototype.task = {
    showTask: function (m) {
        var n = this, k = n.util, j = n.model, b = m || k.getSelectedId(), l = n.operation, e = n.task;
        if (b == null || $.trim(b) == "") {
            return
        }
        if (n.opts.readonly) {
        ...
        var h = $("#mind-task-box");
        if (h.length == 0) {
            h = $("<div id='mind-task-box' class='mind-topic-box'><h3>浠诲姟<a id='remove-task' style='cursor:pointer;font-size:13px;font-size: 13px;font-weight: normal;float: right;text-decoration: underline;'>鍒犻櫎</a></h3></div>").appendTo(n.designer);
            h.append(c)
        }
        $.fn.showPanel({target: g, panel: h});
        if (i.task != null) {
            var a = $("#mind-icons-priority-list"), q = $("#mind-icons-completion-list");
            ...
            if (o != "") {
                ...
                $("#mind-task-priority").children("span").text("鏃�")
            }
            if (d != "") {
                $("#mind-task-completion").children("span").text(d)
            } else {
                $("#mind-task-completion").children("span").text("鏃�")
            }
            p.remove();
            f.remove();
            $("#mind-task-start").find("span").text(i.task.start || "鏃�");
            $("#mind-task-end").find("span").text(i.task.end || "鏃�");
        ...
        $("#remove-task").on("click", function () {
            ...
            $(".mind-dock-right-task").find(".mind-select-box").text("鏃�")
        })
    }, setTask: function (d, a) {
        var g = this, c = g.util, f = g.model, h = a || c.getSelectedId();
        ...
        var e = f.getTopicById(h), b = c.copy(e);
        if (e.task == null) {
            e.task = {}
        }
        ...
        var e = this, b = e.util, d = e.model, f = b.getSelectedId();
        var c = d.getTopicById(f), a = b.copy(c);
        if (c.task == null) {
            return
        }
        delete c.task;
...
mindDesigner.prototype.icons = {
    renderTopicIcons: function (j, h, a) {
        if (h.icons) {
            var p = h.icons, l = this, o = l.icons;
    ...
    }, currentIcon: {}, setIcon: function (r, s, o) {
        var e = this;
        var j = r.attr("ico"), h = r.text(), l = r.attr("n") == null ? "" : r.attr("n");
        var t = {index: j, name: l};
        if (o != null) {
            t.color = o
        } else {
        ...
        var e = this, b = e.util, d = e.model, k = b.getSelectedId();
        if (e.opts.readonly) {
            return
        }
        ...
        var m = d.getTopicById(k), c = b.copy(m);
        ...
        var g = f.getTopicById(a), c = h.copy(g), l = g.icons;
        for (var e = 0, j = l.length; e < j; e++) {
            var b = l[e];
            if (d != null && b.name == d) {
                l.splice(e, 1);
        ...
        face: [{index: 9, text: "&#xe6c8"}, {index: 11, text: "&#xe6ca"}, {index: 10, text: "&#xe6c6"}],
        priority: [{index: 0, text: "&#xe67a"}, {index: 1, text: "&#xe625"}, {index: 2, text: "&#xe62a"}, {
            index: 3,
            text: "&#xe635"
        }, {index: 4, text: "&#xe626"}, {index: 5, text: "&#xe62b"}, {index: 6, text: "&#xe627"}, {
            index: 7,
            text: "&#xe628"
        }, {index: 8, text: "&#xe629"}],
        arrow: [{index: 33, text: "&#xe68c"}, {index: 34, text: "&#xe68e"}, {index: 35, text: "&#xe68d"}, {
            index: 36,
            text: "&#xe68b"
        }, {index: 37, text: "&#xe6a0"}],
        flag: [{index: 26, text: "&#xe67e"}, {index: 27, text: "&#xe67e"}, {index: 28, text: "&#xe67e"}, {
            index: 29,
            text: "&#xe67e"
        }, {index: 30, text: "&#xe67e"}, {index: 31, text: "&#xe67e"}, {index: 32, text: "&#xe67e"}],
        completion: [{index: 17, text: "&#xe6d2"}, {index: 18, text: "&#xe6d3"}, {
            index: 19,
            text: "&#xe6d4"
        }, {index: 20, text: "&#xe6d5"}, {index: 21, text: "&#xe6d6"}, {index: 22, text: "&#xe6d7"}, {
            index: 23,
            text: "&#xe6d8"
        }, {index: 24, text: "&#xe697;"}],
        "": [{index: 38, text: "&#xe6ab"}, {index: 39, text: "&#xe634"}, {index: 40, text: "&#xe640"}, {
            index: 41,
            text: "&#xe692"
        }, {index: 42, text: "&#xe6b8"}, {index: 43, text: "&#xe6bb"}, {index: 44, text: "&#xe6b9"}, {
            index: 45,
            text: "&#xe6bf"
        }, {index: 46, text: "&#xe663"}, {index: 47, text: "&#xe6bd"}, {index: 48, text: "&#xe621"}, {
            index: 49,
            text: "&#xe6bc"
        }, {index: 50, text: "&#xe6c1"}, {index: 51, text: "&#xe609"}, {index: 52, text: "&#xe688"}, {
            index: 53,
            text: "&#xe681"
        }, {index: 54, text: "&#xe639"}, {index: 55, text: "&#xe682"}, {index: 56, text: "&#xe67f"}, {
            index: 57,
            text: "&#xe695"
        }, {index: 58, text: "&#xe689"}, {index: 59, text: "&#xe6be"}, {index: 60, text: "&#xe683"}, {
            index: 61,
            text: "&#xe6c0"
        }, {index: 62, text: "&#xe6b6"}, {index: 63, text: "&#xe680"}, {index: 64, text: "&#xe693"}]
        ...
        var j = this, h = j.util, k = j.icons, g = j.model;
        var f = k.renderIconBox(b, i);
        var c = {index: i, name: b, color: e.css("color")};
        k.currentIcon = c;
        var a = $(f);
        a.appendTo("body");
        $.fn.showPanel({target: e, panel: a});
        k.initIconEvent.call(j)
    }, initIconEvent: function () {
        var a = this, b = a.icons;
        ...
        $(document).off("click.iconcolors").on("click.iconcolors", ".mind-icons-color span", function (d) {
            var f = $(this), c = f.css("background-color");
...
mindDesigner.prototype.style = {
    baseColor: function () {
        ...
        var j = this.model.topic, a = this.style, l = a.themes, g = (j.classic || j.theme), k = this.util;
        if (m != null && m != "" && m != "null") {
            return m
        }
        ...
        var e = j.background;
        h = $.extend(h, {background: e || h.background});
        return h
    }, setTheme: function (f) {
        var g = this, e = g.model, d = g.currentRoot || e.topic;
        var c = "";
        ...
        var e = this, c = e.model, b = c.topic;
        var a = "";
        if (b.classic != null) {
            a = b.classic;
            delete b.classic;
        ...
        mind = new mindDesigner("#mind_con", {chartId: chartId}, b);
        if (f == null) {
            e.messageSource.send.call(e, "setTheme", {content: d, original: a})
        }
    }, setThemeOverWrite: function (d, l) {
        var g = this, e = g.model, h = g.currentRoot || e.topic;
        var a = "";
        if (h.classic != null) {
            a = h.classic;
            delete h.classic;
        ...
        g.render();
        g.messageSource.send.call(g, "setThemeOverWrite", {tps: b, content: d, original: a, operate: "delete"});
        if (l != null) {
            l()
        }
    }, setThemeOverWrite_: function (h, g, c, f) {
        var e = this, d = e.model, b = e.currentRoot || d.topic;
        var a = b.theme;
        if (h != null || h != "") {
            b.theme = h
        }
        ...
        e.render();
        if (f == null) {
            e.messageSource.send.call(e, "setThemeOverWrite", {tps: g, content: h, old: a, operate: c})
        }
        ...
        return b[a]
    }, usedColors: [], getLineColor: function () {
        ...
        theme3: {
            ...
            childMarginH: 8,
            childMarginW: 12,
            common: {family: "寰蒋闆呴粦", bold: false, italic: false, textAlign: "left"},
            connectionStyle: {lineWidth: 2, lineColor: "rgb(113, 203, 45)", color: "#ffffff"},
            centerTopic: {
            ...
            secTopic: {
                ...
                lineStyle: {lineType: "curve", lineWidth: 2, lineColor: "#666"}
            },
            childTopic: {
                "font-size": "13px",
                color: "#666",
                padding: "1px 9px 2px 9px",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "#555", underLine: true}
            }
        },
        "default": {
            background: "#f8f8f8",
            ...
            secTopic: {
                ...
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "rgb(170,170,170)"}
            },
            childTopic: {
                "font-size": "13px",
                color: "rgb(68,68,68)",
                padding: "2px 9px 4px",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "rgb(140,140,140)"}
            }
        },
        niupizhi: {
            ...
            secTopic: {
                ...
                lineStyle: {lineType: "curve", lineWidth: 1, lineColor: "rgb(187, 136, 34)"}
            },
            childTopic: {
                "font-size": "13px",
                color: "rgb(187, 136, 34)",
                padding: "2px 9px 4px",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "rgb(187, 136, 34)"}
            }
        },
        shangwu: {
            background: "#f8f8f8",
            ...
            secTopic: {
                ...
                "font-size": "17px",
                padding: "10px 10px 10px 10px",
                lineStyle: {lineType: "curve", lineWidth: 1, lineColor: "rgb(0, 0, 204)"}
            },
            childTopic: {
                "font-size": "13px",
                color: "rgb(102, 102, 255)",
                padding: "2px 9px 4px",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "rgb(102, 102, 255)"}
            }
        },
        theme1: {
            background: "#ffffdd",
            ...
            secTopic: {
                ...
                "font-size": "17px",
                padding: "10px",
                lineStyle: {lineType: "straight", lineWidth: 4, lineColor: "rgb(170,170,170)"}
            },
            childTopic: {
                "font-size": "13px",
                color: "rgb(68,68,68)",
        ...
        caihongpao: {
            ...
            secTopic: {
                ...
                lineStyle: {lineType: "curve", lineWidth: 2, lineColor: "#43a9ff"}
            },
            childTopic: {
                "font-size": "12px",
                "border-radius": "5px",
                ...
                padding: "3px 9px 4px",
                boxShadow: "1px 1px 1px #ccc",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "#43a9ff"}
            }
        },
        caihongthinner: {
            background: "#f8f8f8",
            thumbUrl: "/assets/images/mind/chl.jpg",
            title: "鏈夎壊褰╃殑绾挎潯Thinner",
            thinner: true,
            autoColor: true,
            marginH: 30,
            marginW: 80,
            ...
            secTopic: {
                ...
                "font-size": "17px",
                padding: "10px 10px 10px 10px",
                lineStyle: {lineType: "curve", lineWidth: 8, lineColor: "rgb(170,170,170)"}
            },
            childTopic: {
                "font-size": "13px",
                color: "rgb(68,68,68)",
                padding: "2px 9px 3px",
                lineStyle: {lineType: "roundBroken", lineWidth: 2, lineColor: "rgb(140,140,140)", underLine: true}
            }
        },
        colorLines: {
            background: "#f8f8f8",
            ...
            secTopic: {
                ...
                "font-size": "17px",
                padding: "10px 10px 10px 10px",
                lineStyle: {lineType: "curve", lineWidth: 5, lineColor: "#3aa9ce"}
            },
            childTopic: {
                "font-size": "13px",
                color: "rgb(68,68,68)",
                padding: "2px 9px 4px",
                lineStyle: {lineType: "roundBroken", lineWidth: 2, lineColor: "rgb(58, 169, 206)", underLine: true}
            }
        },
        caihong: {
            background: "#f8f8f8",
            ...
            childTopic: {
                ...
                color: "rgb(68,68,68)",
                padding: "3px 9px 4px",
                lineStyle: {lineType: "curve", lineWidth: 1, lineColor: "rgb(140,140,140)"}
            }
        },
        jianbihua: {
            ...
            childMarginH: 20,
            childMarginW: 20,
            common: {family: "Comic Sans MS,寰蒋闆呴粦", bold: false, italic: false, textAlign: "left"},
            connectionStyle: {lineWidth: 2, lineColor: "rgb(113, 203, 45)", color: "#ffffff"},
            centerTopic: {
                ...
                borderStyle: "solid",
                "-webkit-border-image": "url(https://www.processon.com/assets/images/mind/border.png) 35 60 45 60",
                "border-image": "url(https://www.processon.com/assets/images/mind/border.png) 35 60 45 60"
            },
            secTopic: {
                backgroundColor: "rgb(255, 249, 217)",
                color: "rgb(68,68,68)",
                ...
                "border-image": "url(https://www.processon.com/assets/images/mind/border.png) 35 60 45 60",
                borderStyle: "solid",
                lineStyle: {lineType: "curve", lineWidth: 3, lineColor: "rgb(70,70,70)"}
            },
            childTopic: {
                "font-size": "17px",
                color: "rgb(68,68,68)",
                ...
                "border-image": "url(https://www.processon.com/assets/images/mind/border.png) 35 60 45 60",
                borderStyle: "solid",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "rgb(110,110,110)"}
            }
        },
        black: {
            ...
            childMarginW: 20,
            common: {family: "寰蒋闆呴粦", bold: false, italic: false, textAlign: "left"},
            connectionStyle: {lineWidth: 2, lineColor: "#e8eaec", color: "#333"},
            centerTopic: {
            ...
            secTopic: {
                ...
                "border-radius": "20px",
                lineStyle: {lineType: "curve", lineWidth: 3, lineColor: "#e8eaec"}
            },
            childTopic: {
                "font-size": "12px",
                color: "#ffffff",
                ...
                lineStyle: {lineType: "roundBroken", lineWidth: 2, lineColor: "#e8eaec"}
            }
        },
        simple: {
            background: "#f8f8f8",
            ...
            childMarginH: 8,
            childMarginW: 14,
            common: {family: "寰蒋闆呴粦", bold: false, italic: false, textAlign: "center"},
            connectionStyle: {lineWidth: 1, lineColor: "rgb(113, 203, 45)", color: "#ffffff"},
            centerTopic: {
                backgroundColor: "#50C28B",
                color: "#fff",
                "font-size": "26px",
            ...
            secTopic: {
                ...
                "font-size": "17px",
                padding: "8px 12px 8px 12px",
                lineStyle: {lineType: "curve", lineWidth: 1, lineColor: "rgb(170,170,170)"}
            },
            childTopic: {
                "font-size": "13px",
                color: "rgb(68,68,68)",
                padding: "2px 6px 3px",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "rgb(170,170,170)", underLine: true}
            }
        },
        basic: {
            background: "#fcf5de",
            ...
            secTopic: {
                ...
                "font-size": "17px",
                padding: "10px 10px 10px 10px",
                lineStyle: {lineType: "curve", lineWidth: 2, lineColor: "rgb(170,170,170)"}
            },
            childTopic: {
                "font-size": "14px",
                backgroundColor: "#ffffff",
        ...
        paper: {
            ...
            secTopic: {
                ...
                "font-size": "16px",
                padding: "10px 10px 10px 10px",
                lineStyle: {lineType: "curve", lineWidth: 2, lineColor: "#3D474D"}
            },
            childTopic: {
                "font-size": "14px",
                color: "#735C45",
                padding: "2px 9px 4px 9px",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "#3D474D", underLine: true}
            }
        },
        red: {
            background: "#fafafa",
            ...
            childMarginW: 16,
            common: {family: "寰蒋闆呴粦", bold: false, italic: false, textAlign: "left"},
            connectionStyle: {lineWidth: 2, lineColor: "#eb5e41", color: "#ffffff"},
            centerTopic: {
            ...
            secTopic: {
                ...
                "font-size": "16px",
                padding: "10px 10px 10px 10px",
                lineStyle: {lineType: "straight", lineWidth: 2, lineColor: "#eb5e41"}
            },
            childTopic: {
                "font-size": "13px",
                ...
                padding: "2px 9px 4px 9px",
                lineStyle: {lineType: "roundBroken", lineWidth: 1, lineColor: "#eb5e41", underLine: true}
            }
        }
    }, getLineStyle: function (d) {
        var e = this.model, i = this.currentRoot || e.topic, k = this.util.copy(this.styles), a = this.style;
        var f = {};
        ...
        var g = this.model, h = g.topic, m = this.util.copy(this.styles), c = this.style;
        var b = null;
        if (k.root || k.classic) {
        ...
        var e = g.util, h = g.style.getStyle.call(g, d), a = d.style;
        if (g.opts.readonly) {
            return
        }
        if (d.style) {
        ...
        var e = g.util, i = g.currentRoot || g.model.topic, h = g.style.getStyle.call(g, d), a = d.lineStyle;
        ...
        var k = l.util, r = l.line, j = l.model, m = l.currentRoot || l.model.topic;
        ...
        if (b == null) {
            l.messageSource.send.call(l, "setTopicStyle", {content: i.id, original: d, update: q, part: a})
        }
        k.resetSelectDom()
    }
};
mindDesigner.prototype.messageSource = {
    checkLocalStorage: function () {
        ...
        var b = d.model, a = b.topic, c = d.opts;
        if (c.readonly) {
            return
        }
        var e = a.id;
        ...
        return a ? a : null
    }, isUndo: true, messages: [], send: function (e, d, b) {
        var c = this, a = c.messageSource;
        if (this.currentRoot != null) {
            d.focus = true
        }
        a.messages.push({action: e, content: d});
        ...
        stack: [], push: function (c, b, a) {
            ...
            var d = this, b = d.stack, a = b.length;
            if (a == 0) {
                return null
            }
            var c = b[a - 1];
        ...
        var d = f.messageSource, e = f.connection, c = f.model, g = f.operation;
        ...
        d.doWithoutUndo(function () {
            for (var Z = 0; Z < a; Z++) {
                var R = b[Z], k = R.action, u = R.content;
                if (k == "create") {
                    var S = u.content;
                    f.model.removeTopic.call(f, S)
                } else {
                    if (k == "delete") {
                        var S = u.content, A = u.index, ab = u.parts;
                        f.model.addTopicMulti.call(f, S, A, ab);
                        var X = S.length - 1;
                        f.util.selectOne.call(f, S[X])
                    } else {
                        if (k == "updateTitle") {
                            var P = u.content, D = u.original;
                            var E = c.getTopicById(P);
                            f.model.updateTopicText.call(f, E, D);
                            f.util.selectOne.call(f, E)
                        } else {
                            if (k == "updateImage") {
                                var P = u.content, D = u.original, J = u.update, w = u.resize;
                                var E = c.getTopicById(P);
                                var T = f.util.copy(E);
                                T.image = D;
                                f.model.updateTopicImage.call(f, T, E, w);
                                f.util.selectOne.call(f, E)
                            } else {
                                if (k == "setTheme") {
                                    var D = u.original;
                                        ...
                                        if (k == "deleteConnection") {
                                            ...
                                            if (k == "addConnection") {
                                                ...
                                                if (k == "updateConnection") {
                                                    var s = u.content, W = u.original;
                                                    e.updateConnection(f, W, s);
                                                    e.createConnectionByLines(f, [W])
                                                } else {
                                                    if (k == "updatePos") {
                                                        var y = u.content, r = u.original, L = u.newIndex,
                                                            ad = u.oldIndex, V = u.oldPart, j = u.newPart;
                                                        f.model._updateTopicPos.call(f, r, ad, y, L, j, V);
                                                        f.util.selectOne.call(f, y[0])
                                                    } else {
                                                        if (k == "changeToFreeTopic") {
                                                            var p = u.content, B = u.original, I = u.index, v = u.part;
                                                            var ae = f.util.copy(p), t = c.getTopicById(B),
                                                                Q = t.children, h = {};
                                                            ae.parent = B;
                                                            if (v == "left" && t.root) {
                                                                Q = t.leftChildren
                                                            ...
                                                            f.model.updateTopicPos.call(f, [ae], h, true, v);
                                                            f.util.selectOne.call(f, ae)
                                                        } else {
                                                            if (k == "updateFreeTopic") {
                                                                var G = u.content, n = u.original, O = u.topicId;
                                                                var ae = c.getTopicById(O);
                                                                var af = u.oldLines, K = u.lines;
                                                                c.updateFreeTopicPos.call(f, ae, n, af, K)
                                                            } else {
                                                                if (k == "update") {
                                                                    var E = u.content, Y = u.original, ae = u.type;
                                                                    c.updateTopicNode.call(f, Y, E, ae, true)
                                                                } else {
                                                                    if (k == "addFreeTopic") {
                                                                        var E = u.content;
                                                                        ...
                                                                        if (k == "updateBg") {
                                                                            ...
                                                                            if (k == "setThemeOverWrite") {
                                                                                var H = u.original;
                                                                                var U = u.tps;
                                                                                f.style.setThemeOverWrite_.call(f, H, U, "add")
                                                                            } else {
                                                                                if (k == "setTopicStyle") {
                                                                                    var F = u.original;
                                                                                    var O = u.content;
                                                                                    var ae = c.getTopicById(O);
                                                                                    var v = u.part;
                                                                                    f.style.setTopicStyles(f, ae, F, v)
                                                                                } else {
                                                                                    if (k == "changetopicexpand") {
                                                                                        var ag = u.type == "show" ? "hide" : "show";
                                                                                        var O = u.content;
                                                                                        f.operation.showOrHideChildren.call(f, O, ag)
                                                                                    } else {
                                                                                        if (k == "insertParent") {
                                                                                            var E = u.content,
                                                                                                Y = u.original,
                                                                                                v = u.part;
                                                                                            f.model.unInsertParentTopic.call(f, E, Y, v)
                                                                                        } else {
                                                                                            if (k == "addSummary") {
                                                                                                var aa = u.content,
                                                                                                    ab = u.parts;
                                                                                                f.summary.model.removeSummary.call(f, aa, ab)
                                                                                            } else {
                                                                                                if (k == "deleteSummary") {
                                                                                                    var aa = u.content;
                                                                                                    f.summary.model.addSummary.call(f, aa)
                                                                                                } else {
                                                                                                    if (k == "updateSummary") {
                                                                                                        var W = u.original;
                                                                                                        var u = u.content;
                                                                                                        f.summary.updateSummary.call(f, W, u)
                                                                                                    } else {
                                                                                                        if (k == "focus") {
                                                                                                            var W = u.sourceId;
                                                                                                            if (W == null) {
                                                                                                            ...
                                                                                                            f.operation.focusTopic.call(f, W)
                                                                                                        } else {
                                                                                                            if (k == "deleteSelf") {
                                                                                                                var z = u.removed,
                                                                                                                    m = u.add,
                                                                                                                    ...
                                                                                                                    o = u.removedPart,
                                                                                                                    ac = u.removedIndex;
                                                                                                                f.model.addAndRemove.call(f, z, m, o, M, ac)
                                                                                                            } else {
        ...
        d.doWithoutUndo(function () {
            for (var W = 0; W < a; W++) {
                var O = b[W], j = O.action, u = O.content;
                if (j == "create") {
                    var P = u.content, G = u.index, Y = u.parts;
                    f.model.addTopicMulti.call(f, P, G, Y);
                    var U = P.length - 1;
                    f.util.selectOne.call(f, P[U])
                } else {
                    if (j == "delete") {
                        var P = u.content;
                        f.model.removeTopic.call(f, P)
                    } else {
                        if (j == "updateTitle") {
                            var N = u.content, H = u.update;
                            var C = c.getTopicById(N);
                            f.model.updateTopicText.call(f, C, H);
                            f.util.selectOne.call(f, C)
                        } else {
                            if (j == "updateImage") {
                                var N = u.content, H = u.update, B = u.original, w = u.resize;
                                var C = c.getTopicById(N);
                                var Q = f.util.copy(C);
                                Q.image = H;
                                f.model.updateTopicImage.call(f, Q, C, w);
                                f.util.selectOne.call(f, C)
                            } else {
                                if (j == "setTheme") {
                                    var u = u.content;
                                        ...
                                        if (j == "deleteConnection") {
                                            ...
                                            if (j == "addConnection") {
                                                ...
                                                if (j == "updateConnection") {
                                                    var s = u.content, T = u.original;
                                                    e.updateConnection(f, s, T);
                                                    e.createConnectionByLines(f, [s])
                                                } else {
                                                    if (j == "updatePos") {
                                                        var x = u.content, r = u.original, J = u.newIndex,
                                                            aa = u.oldIndex, S = u.oldPart, h = u.newPart;
                                                        f.model._updateTopicPos.call(f, x, J, r, aa, S, h);
                                                        f.util.selectOne.call(f, r[0])
                                                    } else {
                                                        if (j == "changeToFreeTopic") {
                                                            var p = u.content, z = u.original, G = u.index;
                                                            var t = f.util.copy(p);
                                                            var E = t.pos;
                                                            delete t.pos;
                                                            delete t.free;
                                                            ...
                                                            if (j == "updateFreeTopic") {
                                                                var E = u.content, m = u.original, M = u.topicId;
                                                                var ab = c.getTopicById(M);
                                                                c.updateFreeTopicPos.call(f, ab, E)
                                                            } else {
                                                                if (j == "update") {
                                                                    var C = u.content, V = u.original, ab = u.type;
                                                                    c.updateTopicNode.call(f, C, V, ab, true)
                                                                } else {
                                                                    if (j == "addFreeTopic") {
                                                                        var C = u.content;
                                                                        ...
                                                                        if (j == "updateBg") {
                                                                            ...
                                                                            if (j == "setThemeOverWrite") {
                                                                                var F = u.content;
                                                                                var R = u.tps;
                                                                                f.style.setThemeOverWrite_.call(f, F, R, "delete")
                                                                            } else {
                                                                                if (j == "setTopicStyle") {
                                                                                    var D = u.update;
                                                                                    var M = u.content;
                                                                                    var ab = c.getTopicById(M);
                                                                                    var v = u.part;
                                                                                    f.style.setTopicStyles(f, ab, D, v)
                                                                                } else {
                                                                                    if (j == "changetopicexpand") {
                                                                                        var ac = u.type;
                                                                                        var M = u.content;
                                                                                        f.operation.showOrHideChildren.call(f, M, ac)
                                                                                    } else {
                                                                                        if (j == "insertParent") {
                                                                                            var C = u.content,
                                                                                                V = u.original,
                                                                                                v = u.part;
                                                                                            f.model.insertParentTopic.call(f, C, V, v)
                                                                                        } else {
                                                                                            if (j == "addSummary") {
                                                                                                var X = u.content;
                                                                                                f.summary.model.addSummary.call(f, X)
                                                                                            } else {
                                                                                                if (j == "deleteSummary") {
                                                                                                    var X = u.content,
                                                                                                        Y = u.parts;
                                                                                                    f.summary.model.removeSummary.call(f, X, Y)
                                                                                                } else {
                                                                                                    if (j == "updateSummary") {
                                                                                                        var T = u.original;
                                                                                                        var u = u.content;
                                                                                                        f.summary.updateSummary.call(f, u, T)
                                                                                                    } else {
                                                                                                        if (j == "focus") {
                                                                                                            var o = u.targetId;
                                                                                                            ...
                                                                                                            if (j == "deleteSelf") {
                                                                                                                ...
                                                                                                                if (j == "deleteSelfRestore") {
                                                                                                                    var y = u.removed,
                                                                                                                        ...
                                                                                                                        n = u.removedPart,
                                                                                                                        Z = u.removedIndex;
                                                                                                                    f.model.addAndRemove.call(f, y, k, n, K, Z)
                                                                                                                } else {
                                                                                                                    if (j == "hideTopics") {
                                                                                                                        var L = u.ids,
                                                                                                                            Y = u.parts,
        ...
        a();
        this.isUndo = true
    }, excuteMsgDirect: function (P, K) {
        var J = this, c = J.model, H = P.uk, Q = P.client, y = P.msg, ab = [], w = J.operation;
        for (var U = 0; U < y.length; U++) {
            var L = y[U], b = L.action, m = L.content;
            if (b == "create") {
                var M = m.content, A = m.index, W = m.parts;
                c.addTopicMulti.call(J, M, A, W, true);
                ab.push(M[0].id)
            } else {
                if (b == "delete") {
                    var M = m.content;
                    J.model.removeTopic.call(J, M, true)
                } else {
                    if (b == "updateTitle") {
                        var I = m.content, B = m.update;
                        var t = c.getTopicById(I);
                        J.model.updateTopicText.call(J, t, B, true);
                        ab.push(t.id)
                    } else {
                        if (b == "updateImage") {
                            var I = m.content, B = m.update, u = m.original, o = m.resize;
                            var t = c.getTopicById(I);
                            var N = J.util.copy(t);
                            N.image = B;
                            J.model.updateTopicImage.call(J, N, t, o, true);
                            ab.push(t.id)
                        } else {
                            if (b == "setTheme") {
                                var m = m.content;
                                J.style.setThemeDirect.call(J, m, true)
                            } else {
                                if (b == "updateStructure") {
                                    var m = m.content;
                                    w.changeStructure.call(J, m, null, true)
                                } else {
                                    if (b == "deleteConnection") {
                                        var C = m.content;
                                        J.connection.deleteConnectionMulti(J, C, true)
                                    } else {
                                        if (b == "addConnection") {
                                            var C = m.content;
                                            J.connection.createConnectionByLines(J, C);
                                            J.connection.addConnectionMulti(J, C, true)
                                        } else {
                                            if (b == "updateConnection") {
                                                var k = m.content, S = m.original;
                                                J.connection.updateConnection(J, k, S, true);
                                                J.connection.createConnectionByLines(J, [k])
                                            } else {
                                                if (b == "updatePos") {
                                                    var p = m.content, j = m.original, D = m.newIndex, Y = m.oldIndex,
                                                        R = m.oldPart, a = m.newPart;
                                                    J.model._updateTopicPos.call(J, p, D, j, Y, R, a, true)
                                                } else {
                                                    if (b == "changeToFreeTopic") {
                                                        var g = m.content, r = m.original, A = m.index;
                                                        var l = J.util.copy(g);
                                                        var x = l.pos;
                                                        delete l.pos;
                                                        delete l.free;
                                                        l.parent = r;
                                                        c.changeToFreeTopic.call(J, l, x, true)
                                                    } else {
                                                        if (b == "updateFreeTopic") {
                                                            var x = m.content, e = m.original, G = m.topicId;
                                                            var Z = c.getTopicById(G);
                                                            c.updateFreeTopicPos.call(J, Z, x, null, null, true)
                                                        } else {
                                                            if (b == "update") {
                                                                var t = m.content, T = m.original, Z = m.type;
                                                                c.updateTopicNode.call(J, t, T, Z, true, true);
                                                                ab.push(t.id)
                                                            } else {
                                                                if (b == "addFreeTopic") {
                                                                    var t = m.content;
                                                                    c.addFreeTopic(t, t.pos, J, true);
                                                                    ab.push(t.id)
                                                                } else {
                                                                    if (b == "updateBg") {
                                                                        var s = m.content;
                                                                        J.operation.setBackground.call(J, s, true, true)
                                                                    } else {
                                                                        if (b == "setThemeOverWrite") {
                                                                            var z = m.content;
                                                                            var O = m.tps;
                                                                            J.style.setThemeOverWrite_.call(J, z, O, "delete", true)
                                                                        } else {
                                                                            if (b == "setTopicStyle") {
                                                                                var v = m.update;
                                                                                var G = m.content;
                                                                                var Z = c.getTopicById(G);
                                                                                var n = m.part;
                                                                                J.style.setTopicStyles(J, Z, v, n, true);
                                                                                ab.push(Z.id)
                                                                            } else {
                                                                                if (b == "changetopicexpand") {
                                                                                    var aa = m.type;
                                                                                    var G = m.content;
                                                                                    J.operation.showOrHideChildren.call(J, G, aa, true);
                                                                                    ab.push(G)
                                                                                } else {
                                                                                    if (b == "insertParent") {
                                                                                        var t = m.content,
                                                                                            T = m.original, n = m.part;
                                                                                        J.model.insertParentTopic.call(J, t, T, n, true)
                                                                                    } else {
                                                                                        if (b == "addSummary") {
                                                                                            var V = m.content;
                                                                                            J.summary.model.addSummary.call(J, V, true)
                                                                                        } else {
                                                                                            if (b == "deleteSummary") {
                                                                                                var V = m.content,
                                                                                                    W = m.parats;
                                                                                                J.summary.model.removeSummary.call(J, V, W, true)
                                                                                            } else {
                                                                                                if (b == "updateSummary") {
                                                                                                    var S = m.original;
                                                                                                    var m = m.content;
                                                                                                    J.summary.updateSummary.call(J, m, S, true)
                                                                                                } else {
                                                                                                    if (b == "deleteSelf") {
                                                                                                        var q = m.removed,
                                                                                                            d = m.add,
                                                                                                            E = m.addPart,
                                                                                                            f = m.removedPart;
                                                                                                        J.model.removeAndAdd.call(J, q, d, f, E, true)
                                                                                                    } else {
                                                                                                        if (b == "deleteSelfRestore") {
                                                                                                            var q = m.removed,
                                                                                                                ...
                                                                                                                f = m.removedPart,
                                                                                                                X = m.removedIndex;
                                                                                                            J.model.addAndRemove.call(J, q, d, f, E, X, true)
                                                                                                        } else {
                                                                                                            if (b == "hideTopics") {
                                                                                                                var F = m.ids,
                                                                                                                    W = m.parts,
                                                                                                                    h = m.withChildren;
                                                                                                                J.model.hideTopics.call(J, F, h, true)
                                                                                                            } else {
                                                                                                                if (b == "showTopics") {
                                                                                                                    var F = m.ids,
                                                                                                                        W = m.parts,
                                                                                                                        h = m.withChildren;
                                                                                                                    J.model.showTopics.call(J, F, h, true)
                                                                                                                }
                                                                                                            }
                                                                                                        }
                                                                                                    }
...
mindDesigner.prototype.plugins = {
    showContextMenu: function (j, b) {
        var n = this, l = n.model, m = n.util, e = n.connection, g = n.operation, h = n.plugins;
        n.events.push("hidepopeditor");
        n.operation.hideLink();
        var i = $(window).width(), f = $(window).height();
        ...
        var a = {x: q.x, y: q.y, h: j.outerHeight(), w: j.outerWidth()};
        c.appendTo(n.designer);
        c.css({left: a.x + a.w, top: a.y - 30, opacity: 0}).show();
        var p = a.x + a.w;
        var o = a.y - 30;
        ...
        c.stop().animate({left: p, top: o, opacity: 1, "z-index": 9}, 10);
        ...
        if (g.length > 0) {
            ...
            var f = $(".mind-summary-menu"), e = g.offset();
            var d = e.left + 20;
        ...
        var c = $(".mind-connection-con[conn=" + a.id + "]").find(".mind-icons"), b = c.offset();
        d.css({left: b.left + c.outerWidth() + 10, top: b.top + c.outerHeight() / 2 - 4});
        d.show()
        ...
        function j(k) {
            ...
            $(document).off("click.iconcolors").on("click.iconcolors", ".mind-icons-color span", function (m) {
                var n = $(this), l = n.css("background-color");
        ...
        function d(p, r) {
            ...
            a.css({left: r.offset().left, top: r.offset().top + 36});
        ...
        baseCalc: null, globalPos: null, init: function () {
            if (typeof showCanvas == "undefined") {
                return
            }
            var g = this, j = g.plugins.navigator;
            ...
            if (a.length == 0) {
                ...
                var c = '<span tit="full" title="鍏ㄥ睆" title_pos="top" class="mind-icons">&#xe665;</span><span title="' + h + '" title_pos="top" tit="close" style="vertical-align:-1px;" class="mind-icons">&#xe705;</span><span title="瀹氫綅鍒颁腑蹇冧富棰�" title_pos="top" tit="focus" class="mind-icons">&#xe60e;</span><span title="缂╁皬" title_pos="top" tit="zoomout" class="mind-icons mind-zoomout">&#xe615;</span><span title="鏀惧ぇ" title_pos="top" tit="zoomin" class="mind-icons mind-zoomin">&#xe630;</span><span title_pos="top" title="杩樺師" tit="zoomtext" class="mind-zoomtxt">100%</span>';
                f.append(c);
                if (showCanvas == "false") {
            ...
            var i = j.calcPos(false, true), e = 250, b = 171;
            j.globalPos = i;
            ...
            var d = $(".mind-canvas-con"), e = d.children(".mind-canvas-op");
                    ...
                    if (g.requestFullscreen) {
                        ...
                        if (g.mozRequestFullScreen) {
                            ...
                            if (g.webkitRequestFullscreen) {
                                ...
                                $.showTip("褰撳墠娴忚鍣ㄤ笉鏀寔鍏ㄥ睆鎿嶄綔锛岃浣跨敤鍏朵粬娴忚鍣ㄥ皾璇�", 2000)
                            }
                        }
                    }
        ...
        }, resetCanvas: true, showCanvas: function () {
            var a = $(".mind-canvas");
            a.show()
        }, hideCanvas: function () {
            var a = $(".mind-canvas");
            ...
            var d = $("#mind_con"), k = d.children(".mind-designer"), a = k.find(".topic-box");
            var b = $(".mind-canvas").children("canvas")[0];
            var j = b.getContext("2d");
            j.clearRect(0, 0, b.width, b.height);
            var c = l.w / h.w;
            var e = mind, g = e.currentRoot || e.model.topic;
            this.baseCalc = c;
            a.each(function (r, p) {
                var t = $(p), q = t.offset(), m = t.attr("id");
                var z = q.left, u = q.top, A = t.outerWidth() * (c), s = t.outerHeight() * (c);
                var o = (z - h.x) * (c);
                var n = (u - h.y) * (c);
            ...
            var b = $(".mind-canvas"), c = b.find("canvas");
            if (c.length == 0) {
                return
            }
            var e = this.baseCalc;
            ...
            var d = c.position().left, h = c.position().top;
            var a = g.x - i.x, k = g.y - i.y;
            ...
            function f() {
                var l = g.w * e;
                var m = g.h * e;
                j.css({left: a * e + d, top: k * e + h, width: l - 4, height: m - 4})
            }

            this.initViewportEvent()
        }, initViewportEvent: function (f) {
            var d = $(".mind-canvas"), b = d.find("canvas");
            var f = d.children(".viewport");
            var c = this.baseCalc;
            var a = this;
            var e = $(document);
            f.on("mousedown", function (l) {
                var o = l.pageX, n = l.pageY;
                var r = f.position().left, q = f.position().top;
                var s = f.outerWidth(), m = f.outerHeight();
                var i = f.parent(), p = i.width(), j = i.height();
                var k = $("#mind_con"), h = k.scrollLeft(), g = k.scrollTop();
                e.on("selectstart", function () {
                    return false
                });
                e.off("mousemove.nav").on("mousemove.nav", function (z) {
                    var x = z.pageX, y = z.pageY;
                    var v = x - o, t = y - n;
                    var w = r + v;
                    var u = q + t;
                    f.css({left: w, top: u});
            ...
            d.off("mousedown").on("mousedown", function (n) {
                var m = $("#mind_con"), j = m.scrollLeft(), g = m.scrollTop();
                var r = d.children(".viewport");
                if (!r.is(":visible")) {
                    r.css({width: 120, height: 60, left: 65, top: 55.5}).show();
                ...
                var q = r.width();
                var l = r.height();
                var p = n.offsetX - q / 2, o = n.offsetY - l / 2;
                r.css({left: p, top: o});
            ...
            var b = $("#mind_con"), d = b.children(".mind-designer");
            ...
            var f = "first", e = 0, c = 0, a = 0;
            var i = $(window).width(), g = $(window).height();
            b.each(function (k, m) {
                var j = $(m), l = j.offset();
                if (h && l.left < 0) {
                    return true
        ...
        ready: function (a) {
            if (this.sliders.length == 0) {
                $.showTip("close");
                $.showTip("[ Cril + 鎷栨嫿 ] 閫夋嫨骞舵坊鍔犲够鐏墖", 2000);
                return
            }
            a.util.clearSelect();
        ...
        calcScale: function (d) {
            var e = $(window).width() - 80, c = $(window).height() - 40;
            var b = e / d.w, a = c / d.h;
            if (b <= a) {
                return b
            } else {
        ...
        toSlide: function (h, i) {
            ...
            var c = $(window).width(), l = $(window).height();
            var b = h.container, j = h.designer;
            var f = d.x - c / 2 + d.w / 2;
            var a = d.y - l / 2 + d.h / 2;
            b.stop().animate({scrollLeft: f, scrollTop: a}, 500);
            j.css({
        ...
        exitShowSlide: function (c) {
            var a = c.container, b = c.designer;
            b.css({"transform-origin": "50% 50%", transition: "all 1s", transform: "scale(1)"});
            c.operation.moveToCenter.call(c);
            ...
            for (var e = 0; e < h.length; e++) {
                if (e == f) {
                    ...
                    for (var d = 0, g = a.length; d < g; d++) {
                        var c = a[d], k = c.substring(1);
                        $("#line_" + k).css({opacity: 1})
                    }
                }
            }
        },
        renderSelections: function (f) {
            var e = this.sliders, b = e.length, g = this;
            ...
            if (b > 0) {
                for (var c = 0; c < b; c++) {
                    ...
                    d.css({left: a.pos.x, top: a.pos.y, width: a.pos.w, height: a.pos.h});
        ...
        focusSelection: function (b) {
            ...
            var a = $("<span title='鍒犻櫎' onclick='mind.plugins.presenter.deleteOneSlider.call(mind)' class='selection-del mind-icons'>&#xe60c;</span><span class='selection-dot lt'></span><span class='selection-dot rt'></span><span class='selection-dot lb'></span><span class='selection-dot rb'></span>");
            this.sliderIndex = b.attr("idx");
            a.appendTo(b)
        },
        setSelectionPos: function (a, b) {
            a.css({left: b.x - 0, top: b.y - 0, width: b.w + 0, height: b.h + 0})
        },
        deleteOneSlider: function () {
            var a = this, b = a.plugins.presenter;
        ...
        resetSelectionByTopics: function (j, c, a, u, b) {
            ...
            var d = {}, r = j.x, p = j.y, q = j.x + j.w, o = j.y + j.h;
            for (var k = 0, l = t.length; k < l; k++) {
                var n = $(t[k]), e = n.offset(), g = n.outerWidth(), m = n.outerHeight();
                var s = e.left / b, f = e.top / b;
                if (c + s < r) {
                    r = c + s
                }
                if (c + s + g > q) {
        ...
        initEvent: function (l, o, n, m) {
            var r = l.designer, c = l.container, k = l.plugins.presenter, q = l.operation.zoomVal / 100;
            var p = this.renderSelection();
            var j = o / q, h = n / q, b, a;
            var f = c.scrollLeft(), d = c.scrollTop();
            if (q != 1) {
            ...
            $(document).off("mousemove.presenter").on("mousemove.presenter", function (e) {
                ...
                i.w = b - j;
                i.h = a - h;
                p.css({left: i.x, top: i.y, width: i.w, height: i.h});
        ...
        initDotEvent: function (e) {
            var i = e.designer;
            var c = null, f = {}, j = Math.abs;
            var h = e.operation.zoomVal / 100;
            var d = this;
            var b = e.container.scrollLeft(), a = e.container.scrollTop();
            if (h != 1) {
            ...
            $(document).off("mousedown.selectiondot", ".selection-dot").on("mousedown.selectiondot", ".selection-dot", function (p) {
                ...
                $(document).off("mousemove.selectiondot").on("mousemove.selectiondot", function (t) {
                    ...
                    var w = b + t.pageX, q = w - f.x, u = a + t.pageY, v = u - f.y;
                    if (l.indexOf("rt") > 0) {
                        var r = m.y + m.h;
                        m.y = u;
                        m.w = w - m.x;
