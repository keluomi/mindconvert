window._zhugeSdk = function(e) {
    ...
    0: function(e, t) {
        var i, n, r, o, a, s, c, u, d, p, h, l = window.navigator, f = window.document, g = l.userAgent, v = Array.prototype, m = Object.prototype, _ = m.toString, y = v.forEach, w = Array.isArray, k = v.slice, b = m.hasOwnProperty, S = {}, T = [], z = null, E = {
            each: function(e, t, i) {
                if (null != e)
                    if (y && e.forEach === y)
                        e.forEach(t, i);
            ...
            extend: function(e) {
                return E.each(k.call(arguments, 1), function(t) {
                    for (var i in t)
                        void 0 !== t[i] && (e[i] = t[i])
                }),
                    e
            ...
            hasMobileSdk: function() {
                ...
                return i || z || (z = setInterval(function() {
                ...
                }, 50)),
                    {
                        flag: t,
                        track: function(e, n) {
                            t && (i ? window.zhugeTracker ? window.zhugeTracker.trackProperty(e, E.JSONEncode(n)) : window.webkit.messageHandlers.zhugeTracker.postMessage({
                                type: "track",
                                name: e,
                                prop: n
                            }) : T.push(["track", [e, n]]))
                        ...
                        identify: function(e, n) {
                            t && (i ? window.zhugeTracker ? window.zhugeTracker.identifyProperty(e, E.JSONEncode(n)) : window.webkit.messageHandlers.zhugeTracker.postMessage({
                                type: "identify",
                                name: e,
                                prop: n
                            }) : T.push(["identify", [e, n]]))
                        ...
                        autoTrack: function(e, n) {
                            t && (i ? window.zhugeTracker ? window.zhugeTracker.autoTrackProperty(e, E.JSONEncode(n)) : window.webkit.messageHandlers.zhugeTracker.postMessage({
                                type: "autoTrack",
                                name: e,
                                prop: n
                        ...
                        getDid: function() {
                            if (t && window.zhugeTracker) {
                                if (E.isString(window.zhugeTracker.did))
                                    return window.zhugeTracker.did;
                                if (E.isFunction(window.zhugeTracker.getDid))
                                    return window.zhugeTracker.getDid();
                                if (E.isString(window.zhugeDid))
            ...
            truncate: function(e, t) {
                var i;
                return "string" == typeof e ? i = e.slice(0, t) : E.isArray(e) ? (i = [],
                    E.each(e, function(e) {
                        i.push(E.truncate(e, t))
                    })) : E.isObject(e) ? (i = {},
            ...
            strip_empty_properties: function(e) {
                var t = {};
                return E.each(e, function(e, i) {
                    E.isString(e) && e.length > 0 && (t[i] = e)
                }),
                    t
            },
            trim: function(e) {
            ...
            cookie: {
                ...
                set: function(e, t, i, n, r) {
                    ...
                    r && (s = "; secure"),
                        f.cookie = e + "=" + encodeURIComponent(t) + a + "; path=/" + o + s
                },
                remove: function(e) {
            ...
            info: {
                campaignParams: function(e) {
                    e || (e = "{}"),
                    E.isString(e) && (e = E.JSONDecode(e));
                    var t = "utm_source utm_medium utm_campaign utm_content utm_term".split(" ")
                        , i = ""
                        , n = {};
                    return E.each(t, function(t) {
                        ((i = E.getQueryParam(f.URL, t)).length || e[t]) && (n["$" + t] = e[t] || i)
                    }),
                        n
                },
                ...
                searchKeyword: function(e) {
                    var t = E.info.searchEngine(e);
                    return "google" == t ? E.getQueryParam(e, "q") : "baidu" == t ? E.getQueryParam(e, "wd") : "sogou" == t ? E.getQueryParam(e, "query") : "haosou" == t ? E.getQueryParam(e, "q") : null
                },
                ...
                browser: function(e, t, i) {
                    t = t || "";
                    return i ? E.includes(e, "Mini") ? "Opera Mini" : "Opera" : /(BlackBerry|PlayBook|BB10)/i.test(e) ? "BlackBerry" : E.includes(e, "FBIOS") ? "Facebook Mobile" : E.includes(e, "Chrome") ? "Chrome" : E.includes(e, "CriOS") ? "Chrome iOS" : E.includes(t, "Apple") ? E.includes(e, "Mobile") ? "Mobile Safari" : "Safari" : E.includes(e, "Android") ? "Android Mobile" : E.includes(e, "Konqueror") ? "Konqueror" : E.includes(e, "Firefox") ? "Firefox" : E.includes(e, "MSIE") || E.includes(e, "Trident/") ? "Internet Explorer" : E.includes(e, "Gecko") ? "Mozilla" : ""
                },
                os: function() {
                    var e = g;
    ...
    5: function(e, t, i) {
        ...
        function a(e, t) {
            var i = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP")
                , a = function(e) {
                n.isFunction(t[e]) && t[e].call(t.context, function(e, t) {
    ...
    72: function(e, t, i) {
        ...
        c.prototype = {
            ...
            _onView: function() {
                this.tracker.config.disableAutoPv || this.tracker._trackPV()
            },
            getEvent: function(e) {
    ...
    73: function(e, t, i) {
        var n = i(0)
            ...
            , h = null
            , l = ["eid", "ct", "tz", "cuid", "cn", "sid", "url", "os", "ov", "wv", "mnet", "referrer_domain", "net", "vn", "wxeid", "uid", "share_id", "share_title", "title", "path", "share_level"]
            , f = (i(14),
            i(16))
            , g = i(7)
            , v = function(e) {
        ...
        v.prototype._init = function(e, t, i) {
            ...
            var o = this
                ...
                o.config.disableAutoPv || o._trackPV())
            };
            ...
            v.prototype._initLanding = function() {
                var e = this
                    , t = function(t) {
                    e.config.autoTrack && (h && clearTimeout(h),
            ...
            v.prototype._startZgSee = function() {
                var e = this;
                e.config.zgsee && !e.config.autoUploadByApp && r("https://ubak.zhugeio.com/appkey/" + this.getKey(), {
                    type: "get",
                    success: function(t) {
            ...
            ,
            v.prototype._trackPV = function() {
                var e = {
                    $page_url: window.location.href,
                    $page_title: window.document.title
                };
                this.is_landing && (e.$landing_page = !0);
                var t = this._getQueryParam();
                if (t.zg_share_id && t.zg_uid) {
                    e.$title = e.$page_title,
                        e.$share_level = t.zg_share_level;
                    var i = {};
                    for (var r in t)
                        l.includes(r.replace("zg_", "")) || 0 !== r.indexOf("zg_") || (i[r.replace("zg_", "")] = t[r]);
                    e = n.extend(e, n.encode(i))
                }
                this.batchTrack([{
                    dt: "abp",
                    eid: "pv",
            ...
            v.prototype._openShare = function() {
                ...
                if (e.zg_share_id && e.zg_uid) {
                    var t = {
                        ...
                        , i = {};
                    for (var r in e)
                        l.includes(r.replace("zg_", "")) || 0 !== r.indexOf("zg_") || (i[r.replace("zg_", "")] = e[r]);
                    this.batchTrack([{
                        dt: "abp",
                        eid: "wxsopen",
    ...
    8: function(e, t) {
        ...
        e.exports = function(e, t, i) {
            return t ? i ? f(t, e) : p(f(t, e)) : i ? l(e) : p(l(e))
        }
    }
});
